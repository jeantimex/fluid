...
export class RaymarchRenderer {
  ...
  render(
    ...
    this.uniformData[19] = vpuX;
    // 20-23: maxBounds, vpuY
    this.uniformData[20] = hx;
    this.uniformData[21] = minY + boundsSize.y;
    this.uniformData[22] = hz;
    this.uniformData[23] = vpuY;
    ...
    // 56-59: dirToSun, pad
    this.uniformData[56] = config.dirToSun.x;
    this.uniformData[57] = config.dirToSun.y;
    this.uniformData[58] = config.dirToSun.z;
    ...
    this.uniformData[63] = config.sunPower;
    ...
    this.uniformData[79] = 0;

    // --- Geometry (80-91) ---
    // 80-83: floorSize, pad
    this.uniformData[80] = config.floorSize.x;
    this.uniformData[81] = config.floorSize.y;
    this.uniformData[82] = config.floorSize.z;
    this.uniformData[83] = 0;
    // 84-87: floorCenter, pad
    this.uniformData[84] = config.floorCenter.x;
    this.uniformData[85] = config.floorCenter.y;
    this.uniformData[86] = config.floorCenter.z;
    this.uniformData[87] = 0;
    ...
    this.uniformData[89] = obstacleIsSphere
    ...
    this.uniformData[92] = showObstacle
      ? obstacleIsSphere
        ? obstacleRadius
        : config.obstacleSize.x * 0.5
      : 0;
    this.uniformData[93] = showObstacle
      ? obstacleIsSphere
        ? obstacleRadius
        : config.obstacleSize.y * 0.5
      : 0;
    this.uniformData[94] = showObstacle
      ? obstacleIsSphere
        ? obstacleRadius
    ...
    this.uniformData[96] = config.obstacleRotation.x;
    this.uniformData[97] = config.obstacleRotation.y;
    this.uniformData[98] = config.obstacleRotation.z;
    this.uniformData[99] = showObstacle ? config.obstacleAlpha : 0;
    // 100-103: obstacleColor, shadowSoftness
    this.uniformData[100] = config.obstacleColor.r;
    this.uniformData[101] = config.obstacleColor.g;
    this.uniformData[102] = config.obstacleColor.b;
    this.uniformData[103] = config.shadowSoftness;
    // 104-107: flags
