...
// Trilinear kernel weight function
fn h(r: f32) -> f32 {
...
// Sample original velocity grid (for FLIP calculation)
...
// =============================================================================
// Grid to Particle (G2P) - FLIP/PIC Blend
// =============================================================================
...
fn advect(@builtin(global_invocation_id) id: vec3<u32>) {
    ...
    // Turbulence using pre-computed random directions
