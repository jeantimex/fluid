...
`;class ${device;particlePipeline;linePipeline;uniformBuffer;gradientBuffer;lineVertexBuffer;lineVertexData;particleBindGroup;lineBindGroup;lineVertexStride=24;lineVertexCapacity=16;clearColor={r:5/255,g:7/255,b:11/255,a:1};uniformData=new Float32Array(8);constructor(e,t,i){this.device=e,this.uniformBuffer=e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});const s=F(i.colorKeys,i.gradientResolution),n=new Float32Array(i.gradientResolution*4);for(let o=0;o<s.length;o++)n[o*4]=s[o].r,n[o*4+1]=s[o].g,n[o*4+2]=s[o].b,n[o*4+3]=1;this.gradientBuffer=e.createBuffer({size:n.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,mappedAtCreation:!0}),new Float32Array(this.gradientBuffer.getMappedRange()).set(n),this.gradientBuffer.unmap(),this.lineVertexData=new Float32Array(this.lineVertexCapacity*6),this.lineVertexBuffer=e.createBuffer({size:this.lineVertexData.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});const r=e.createShaderModule({code:j});this.particlePipeline=e.createRenderPipeline({layout:"auto",vertex:{module:r,entryPoint:"vs_main"},fragment:{module:r,entryPoint:"fs_main",targets:[{format:t}]},primitive:{topology:"triangle-list"}});const a=e.createShaderModule({code:Z});this.linePipeline=e.createRenderPipeline({layout:"auto",vertex:{module:a,entryPoint:"vs_main",buffers:[{arrayStride:this.lineVertexStride,attributes:[{shaderLocation:0,offset:0,format:"float32x2"},{shaderLocation:1,offset:8,format:"float32x4"}]}]},fragment:{module:a,entryPoint:"fs_main",targets:[{format:t}]},primitive:{topology:"line-list"}}),this.lineBindGroup=e.createBindGroup({layout:this.linePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.uniformBuffer}}]})}createBindGroup(e){this.particleBindGroup=this.device.createBindGroup({layout:this.particlePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:e.positions}},{binding:1,resource:{buffer:e.velocities}},{binding:2,resource:{buffer:this.gradientBuffer}},{binding:3,resource:{buffer:this.uniformBuffer}}]})}updateUniforms(e,t,i){const s=window.devicePixelRatio||1;this.uniformData[0]=e.boundsSize.x,this.uniformData[1]=e.boundsSize.y,this.uniformData[2]=t,this.uniformData[3]=i,this.uniformData[4]=e.particleRadius*s,this.uniformData[5]=e.velocityDisplayMax,this.uniformData[6]=e.gradientResolution,this.uniformData[7]=0,this.device.queue.writeBuffer(this.uniformBuffer,0,this.uniformData)}render(e,t,i,s){let n=0;const r=(m,p,h,g,d,x,B,D)=>{const l=n*6;this.lineVertexData[l]=m,this.lineVertexData[l+1]=p,this.lineVertexData[l+2]=d,this.lineVertexData[l+3]=x,this.lineVertexData[l+4]=B,this.lineVertexData[l+5]=D,this.lineVertexData[l+6]=h,this.lineVertexData[l+7]=g,this.lineVertexData[l+8]=d,this.lineVertexData[l+9]=x,this.lineVertexData[l+10]=B,this.lineVertexData[l+11]=D,n+=2},a=i.boundsSize.x*.5,o=i.boundsSize.y*.5,c={r:27/255,g:36/255,b:50/255,a:1};if(r(-a,-o,a,-o,c.r,c.g,c.b,c.a),r(a,-o,a,o,c.r,c.g,c.b,c.a),r(a,o,-a,o,c.r,c.g,c.b,c.a),r(-a,o,-a,-o,c.r,c.g,c.b,c.a),i.obstacleSize.x>0&&i.obstacleSize.y>0){const m=i.obstacleSize.x*.5,p=i.obstacleSize.y*.5,h=i.obstacleCentre.x,g=i.obstacleCentre.y,d={r:54/255,g:81/255,b:109/255,a:1};r(h-m,g-p,h+m,g-p,d.r,d.g,d.b,d.a),r(h+m,g-p,h+m,g+p,d.r,d.g,d.b,d.a),r(h+m,g+p,h-m,g+p,d.r,d.g,d.b,d.a),r(h-m,g+p,h-m,g-p,d.r,d.g,d.b,d.a)}this.device.queue.writeBuffer(this.lineVertexBuffer,0,this.lineVertexData.subarray(0,n*6));const y=t.getCurrentTexture().createView(),v=e.beginRenderPass({colorAttachments:[{view:y,clearValue:this.clearColor,loadOp:"clear",storeOp:"store"}]});v.setPipeline(this.particlePipeline),v.setBindGroup(0,this.particleBindGroup),v.draw(6,s),n>0&&(v.setPipeline(this.linePipeline),v.setBindGroup(0,this.lineBindGroup),v.setVertexBuffer(0,this.lineVertexBuffer),v.draw(n)),v.end()}}const J={useGpuExternalForces:!0,useGpuSpatialHash:!0,useGpuDensity:!0,useGpuDensityReadback:!1,useCpuSpatialDataForGpuDensity:!1,useGpuPressure:!0,useGpuViscosity:!0};class Q{device;context;canvas;config;options;buffers;pipelines;renderer;physics;state;workgroupSize=256;computeData=new Float32Array(8);hashParamsData=new Float32Array(4);sortParamsData=new Uint32Array(4);densityParamsData=new Float32Array(12);pressureParamsData=new Float32Array(12);viscosityParamsData=new Float32Array(12);integrateParamsData=new Float32Array(16);constructor(e,t,i,s,n,r={}){this.device=e,this.context=t,this.canvas=i,this.config=s,this.options={...J,...r},this.pipelines=new N(e),this.renderer=new $(e,n,s),this.reset()}get particleCount(){return this.buffers.particleCount}get simulationState(){return this.state}getScale(){return this.canvas.width/this.config.boundsSize.x}reset(){this.buffers&&this.buffers.destroy();const e=M(this.config);this.state=this.createStateFromSpawn(e),this.buffers=new q(this.device,e),this.physics=z(this.state,this.config,()=>this.getScale()),this.pipelines.createBindGroups(this.buffers),this.renderer.createBindGroup(this.buffers)}refreshSettings(){this.physics.refreshSettings()}createStateFromSpawn(e){return{positions:e.positions,predicted:new Float32Array(e.positions),velocities:e.velocities,densities:new Float32Array(e.count*2),keys:new Uint32Array(e.count),sortedKeys:new Uint32Array(e.count),indices:new Uint32Array(e.count),sortOffsets:new Uint32Array(e.count),spatialOffsets:new Uint32Array(e.count),positionsSorted:new Float32Array(e.count*2),predictedSorted:new Float32Array(e.count*2),velocitiesSorted:new Float32Array(e.count*2),count:e.count,input:{worldX:0,worldY:0,pull:!1,push:!1}}}async step(e){const{options:t,config:i,state:s,buffers:n,pipelines:r,device:a}=this;if(t.useGpuExternalForces){const o=i.maxTimestepFPS?1/i.maxTimestepFPS:Number.POSITIVE_INFINITY,y=Math.min(e*i.timeScale,o)/i.iterationsPerFrame,v=window.devicePixelRatio||1,p=(Math.max(1,Math.round(i.particleRadius))+i.boundsPaddingPx)*v/this.getScale(),h=Math.max(0,i.boundsSize.x*.5-p),g=Math.max(0,i.boundsSize.y*.5-p),d=i.obstacleSize.x>0&&i.obstacleSize.y>0;for(let x=0;x<i.iterationsPerFrame;x++){let B=!1;const D=s.input.push?-i.interactionStrength:s.input.pull?i.interactionStrength:0;this.computeData[0]=y,this.computeData[1]=i.gravity,this.computeData[2]=i.interactionRadius,this.computeData[3]=D,this.computeData[4]=s.input.worldX,this.computeData[5]=s.input.worldY,a.queue.writeBuffer(r.uniformBuffers.compute,0,this.computeData);const l=a.createCommandEncoder(),G=l.beginComputePass();if(G.setPipeline(r.externalForces),G.setBindGroup(0,r.externalForcesBindGroup),G.dispatchWorkgroups(Math.ceil(n.particleCount/this.workgroupSize)),G.end(),(!t.useGpuDensity||t.useCpuSpatialDataForGpuDensity)&&(this.physics.predictPositions(),this.physics.runSpatialHash()),t.useGpuDensity){t.useCpuSpatialDataForGpuDensity?(a.queue.writeBuffer(n.predicted,0,s.predicted),a.queue.writeBuffer(n.sortedKeys,0,s.sortedKeys),a.queue.writeBuffer(n.spatialOffsets,0,s.spatialOffsets)):t.useGpuSpatialHash&&this.dispatchSpatialHash(l),this.updateDensityUniforms();const f=l.beginComputePass();f.setPipeline(r.density),f.setBindGroup(0,r.densityBindGroup),f.dispatchWorkgroups(Math.ceil(n.particleCount/this.workgroupSize)),f.end(),t.useGpuDensityReadback&&(l.copyBufferToBuffer(n.densities,0,n.densityReadback,0,n.particleCount*2*4),B=!0)}else this.physics.calculateDensities(),t.useGpuPressure&&a.queue.writeBuffer(n.densities,0,s.densities);if(t.useGpuPressure){this.updatePressureUniforms(y);const f=l.beginComputePass();f.setPipeline(r.pressure),f.setBindGroup(0,r.pressureBindGroup),f.dispatchWorkgroups(Math.ceil(n.particleCount/this.workgroupSize)),f.end()}else this.physics.calculatePressure(y);if(t.useGpuViscosity){this.updateViscosityUniforms(y);const f=l.beginComputePass();f.setPipeline(r.viscosity),f.setBindGroup(0,r.viscosityBindGroup),f.dispatchWorkgroups(Math.ceil(n.particleCount/this.workgroupSize)),f.end()}else this.physics.calculateViscosity(y);this.updateIntegrateUniforms(y,h,g,d);const U=l.beginComputePass();if(U.setPipeline(r.integrate),U.setBindGroup(0,r.integrateBindGroup),U.dispatchWorkgroups(Math.ceil(n.particleCount/this.workgroupSize)),U.end(),a.queue.submit([l.finish()]),B){await n.densityReadback.mapAsync(GPUMapMode.READ);const f=new Float32Array(n.densityReadback.getMappedRange());s.densities.set(f),n.densityReadback.unmap()}}}else this.physics.step(e);t.useGpuExternalForces||(a.queue.writeBuffer(n.positions,0,s.positions),a.queue.writeBuffer(n.velocities,0,s.velocities),a.queue.writeBuffer(n.predicted,0,s.predicted))}dispatchSpatialHash(e){const{pipelines:t,buffers:i}=this,s=Math.ceil(i.particleCount/this.workgroupSize);this.hashParamsData[0]=this.config.smoothingRadius,this.hashParamsData[1]=i.particleCount,this.device.queue.writeBuffer(t.uniformBuffers.hash,0,this.hashParamsData),this.sortParamsData[0]=i.particleCount,this.device.queue.writeBuffer(t.uniformBuffers.sort,0,this.sortParamsData);const n=e.beginComputePass();n.setPipeline(t.hash),n.setBindGroup(0,t.hashBindGroup),n.dispatchWorkgroups(s),n.end();const r=e.beginComputePass();r.setPipeline(t.clearOffsets),r.setBindGroup(0,t.clearOffsetsBindGroup),r.dispatchWorkgroups(s),r.end();const a=e.beginComputePass();a.setPipeline(t.countOffsets),a.setBindGroup(1,t.countOffsetsBindGroup),a.dispatchWorkgroups(s),a.end();const o=e.beginComputePass();o.setPipeline(t.scatter),o.setBindGroup(0,t.scatterBindGroup),o.dispatchWorkgroups(1),o.end();const c=e.beginComputePass();c.setPipeline(t.spatialOffsets),c.setBindGroup(0,t.spatialOffsetsBindGroup),c.dispatchWorkgroups(1),c.end()}updateDensityUniforms(){const e=this.config.smoothingRadius,t=6/(Math.PI*Math.pow(e,4)),i=10/(Math.PI*Math.pow(e,5));this.densityParamsData[0]=e,this.densityParamsData[1]=t,this.densityParamsData[2]=i,this.densityParamsData[3]=this.buffers.particleCount,this.device.queue.writeBuffer(this.pipelines.uniformBuffers.density,0,this.densityParamsData)}updatePressureUniforms(e){const t=this.config.smoothingRadius,i=12/(Math.PI*Math.pow(t,4)),s=30/(Math.PI*Math.pow(t,5));this.pressureParamsData[0]=e,this.pressureParamsData[1]=this.config.targetDensity,this.pressureParamsData[2]=this.config.pressureMultiplier,this.pressureParamsData[3]=this.config.nearPressureMultiplier,this.pressureParamsData[4]=t,this.pressureParamsData[5]=i,this.pressureParamsData[6]=s,this.pressureParamsData[7]=this.buffers.particleCount,this.device.queue.writeBuffer(this.pipelines.uniformBuffers.pressure,0,this.pressureParamsData)}updateViscosityUniforms(e){const t=this.config.smoothingRadius,i=4/(Math.PI*Math.pow(t,8));this.viscosityParamsData[0]=e,this.viscosityParamsData[1]=this.config.viscosityStrength,this.viscosityParamsData[2]=t,this.viscosityParamsData[3]=i,this.viscosityParamsData[4]=this.buffers.particleCount,this.device.queue.writeBuffer(this.pipelines.uniformBuffers.viscosity,0,this.viscosityParamsData)}updateIntegrateUniforms(e,t,i,s){this.integrateParamsData[0]=e,this.integrateParamsData[1]=this.config.collisionDamping,this.integrateParamsData[2]=s?1:0,this.integrateParamsData[3]=0,this.integrateParamsData[4]=t,this.integrateParamsData[5]=i,this.integrateParamsData[6]=0,this.integrateParamsData[7]=0,this.integrateParamsData[8]=this.config.obstacleCentre.x,this.integrateParamsData[9]=this.config.obstacleCentre.y,this.integrateParamsData[10]=this.config.obstacleSize.x*.5,this.integrateParamsData[11]=this.config.obstacleSize.y*.5,this.device.queue.writeBuffer(this.pipelines.uniformBuffers.integrate,0,this.integrateParamsData)}render(){this.renderer.updateUniforms(this.config,this.canvas.width,this.canvas.height);const e=this.device.createCommandEncoder();this.renderer.render(e,this.context,this.config,this.buffers.particleCount),this.device.queue.submit([e.finish()])}}class O extends Error{constructor(e){super(e),this.name="WebGPUInitError"}}async function ee(u){if(!navigator.gpu)throw new O("WebGPU is not supported in this browser.");const e=await navigator.gpu.requestAdapter();if(!e)throw new O("Unable to acquire a WebGPU adapter.");const t=await e.requestDevice(),i=u.getContext("webgpu");if(!i)throw new O("Unable to create a WebGPU context.");const s=navigator.gpu.getPreferredCanvasFormat();return{device:t,context:i,format:s}}function te(u,e,t){u.configure({device:e,format:t,alphaMode:"opaque"})}function ie(u){u.innerHTML='<canvas id="sim-canvas" aria-label="Fluid simulation"></canvas>';const e=document.querySelector("#sim-canvas");if(!e)throw new Error("Failed to create canvas element");return e}function ne(u,e,t,i){const s=u.getBoundingClientRect(),n=window.devicePixelRatio||1,r=(e-s.left)*n,a=(t-s.top)*n,o=u.width*.5,c=u.height*.5;return{x:(r-o)/i,y:(c-a)/i}}function se(u,e,t){const i=s=>{const n=e();if(!n)return;const r=ne(u,s.clientX,s.clientY,t());n.worldX=r.x,n.worldY=r.y};u.addEventListener("pointermove",i),u.addEventListener("pointerdown",s=>{const n=e();n&&(i(s),s.button===0&&(n.pull=!0),s.button===2&&(n.push=!0))}),u.addEventListener("pointerup",s=>{const n=e();n&&(s.button===0&&(n.pull=!1),s.button===2&&(n.push=!1))}),u.addEventListener("pointerleave",()=>{const s=e();s&&(s.pull=!1,s.push=!1)}),u.addEventListener("contextmenu",s=>{s.preventDefault()})}function re(u,e,t,i,s){let n=null;const r=()=>{const a=u.getBoundingClientRect();n===null&&(n=e.boundsSize.x/Math.max(1,a.width));const o=window.devicePixelRatio||1,c=Math.max(1,Math.round(a.width*o)),y=Math.max(1,Math.round(a.height*o));(u.width!==c||u.height!==y)&&(u.width=c,u.height=y,e.boundsSize={x:u.width/o*n,y:u.height/o*n},te(t,i,s))};return window.addEventListener("resize",r),r}const _=document.querySelector("#app");if(!_)throw new Error("Missing #app container");const S=ie(_),w=T();let b=null,k;const P={paused:!1,togglePause:()=>{P.paused=!P.paused,k&&k.name(P.paused?"Resume":"Pause")},reset:()=>b?.reset()},{stats:C,gui:Y}=A(w,{onReset:()=>b?.reset(),onSmoothingRadiusChange:()=>b?.refreshSettings()},{trackGPU:!0,title:"WebGPU 2D Fluid",subtitle:"SPH Fluid • Particle Simulation",features:["SPH Fluid Simulator (GPU)","WebGPU Compute Pipelines","Bitonic Sort Optimization","Spatial Grid Optimization","High-Performance Rendering"],interactions:["Click & Drag: Pull Particles","Right Click & Drag: Push Particles","Mouse Wheel: Zoom In/Out"],githubUrl:"https://github.com/jeantimex/fluid"});k=Y.add(P,"togglePause").name(P.paused?"Resume":"Pause");Y.add(P,"reset").name("Reset Simulation");async function ae(){let u,e,t;try{({device:u,context:e,format:t}=await ee(S))}catch(a){if(a instanceof O){_.innerHTML=`<p>${a.message}</p>`;return}throw a}b=new Q(u,e,S,w,t),se(S,()=>b?.simulationState.input,()=>S.width/w.boundsSize.x),re(S,w,e,u,t)();let n=performance.now();const r=async a=>{C.begin();const o=Math.min(.033,(a-n)/1e3);n=a,P.paused||await b.step(o),b.render(),C.end(),C.update(),requestAnimationFrame(r)};requestAnimationFrame(r)}ae();
