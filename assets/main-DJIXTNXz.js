...
`;class ${device;particlePipeline;linePipeline;uniformBuffer;gradientBuffer;lineVertexBuffer;lineVertexData;particleBindGroup;lineBindGroup;lineVertexStride=24;lineVertexCapacity=16;clearColor={r:5/255,g:7/255,b:11/255,a:1};uniformData=new Float32Array(8);constructor(e,t,i){this.device=e,this.uniformBuffer=e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});const n=F(i.colorKeys,i.gradientResolution),s=new Float32Array(i.gradientResolution*4);for(let o=0;o<n.length;o++)s[o*4]=n[o].r,s[o*4+1]=n[o].g,s[o*4+2]=n[o].b,s[o*4+3]=1;this.gradientBuffer=e.createBuffer({size:s.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,mappedAtCreation:!0}),new Float32Array(this.gradientBuffer.getMappedRange()).set(s),this.gradientBuffer.unmap(),this.lineVertexData=new Float32Array(this.lineVertexCapacity*6),this.lineVertexBuffer=e.createBuffer({size:this.lineVertexData.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});const r=e.createShaderModule({code:j});this.particlePipeline=e.createRenderPipeline({layout:"auto",vertex:{module:r,entryPoint:"vs_main"},fragment:{module:r,entryPoint:"fs_main",targets:[{format:t}]},primitive:{topology:"triangle-list"}});const a=e.createShaderModule({code:Z});this.linePipeline=e.createRenderPipeline({layout:"auto",vertex:{module:a,entryPoint:"vs_main",buffers:[{arrayStride:this.lineVertexStride,attributes:[{shaderLocation:0,offset:0,format:"float32x2"},{shaderLocation:1,offset:8,format:"float32x4"}]}]},fragment:{module:a,entryPoint:"fs_main",targets:[{format:t}]},primitive:{topology:"line-list"}}),this.lineBindGroup=e.createBindGroup({layout:this.linePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.uniformBuffer}}]})}createBindGroup(e){this.particleBindGroup=this.device.createBindGroup({layout:this.particlePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:e.positions}},{binding:1,resource:{buffer:e.velocities}},{binding:2,resource:{buffer:this.gradientBuffer}},{binding:3,resource:{buffer:this.uniformBuffer}}]})}updateUniforms(e,t,i){const n=window.devicePixelRatio||1;this.uniformData[0]=e.boundsSize.x,this.uniformData[1]=e.boundsSize.y,this.uniformData[2]=t,this.uniformData[3]=i,this.uniformData[4]=e.particleRadius*n,this.uniformData[5]=e.velocityDisplayMax,this.uniformData[6]=e.gradientResolution,this.uniformData[7]=0,this.device.queue.writeBuffer(this.uniformBuffer,0,this.uniformData)}render(e,t,i,n){let s=0;const r=(m,p,h,g,d,x,B,G)=>{const l=s*6;this.lineVertexData[l]=m,this.lineVertexData[l+1]=p,this.lineVertexData[l+2]=d,this.lineVertexData[l+3]=x,this.lineVertexData[l+4]=B,this.lineVertexData[l+5]=G,this.lineVertexData[l+6]=h,this.lineVertexData[l+7]=g,this.lineVertexData[l+8]=d,this.lineVertexData[l+9]=x,this.lineVertexData[l+10]=B,this.lineVertexData[l+11]=G,s+=2},a=i.boundsSize.x*.5,o=i.boundsSize.y*.5,c={r:27/255,g:36/255,b:50/255,a:1};if(r(-a,-o,a,-o,c.r,c.g,c.b,c.a),r(a,-o,a,o,c.r,c.g,c.b,c.a),r(a,o,-a,o,c.r,c.g,c.b,c.a),r(-a,o,-a,-o,c.r,c.g,c.b,c.a),i.obstacleSize.x>0&&i.obstacleSize.y>0){const m=i.obstacleSize.x*.5,p=i.obstacleSize.y*.5,h=i.obstacleCentre.x,g=i.obstacleCentre.y,d={r:54/255,g:81/255,b:109/255,a:1};r(h-m,g-p,h+m,g-p,d.r,d.g,d.b,d.a),r(h+m,g-p,h+m,g+p,d.r,d.g,d.b,d.a),r(h+m,g+p,h-m,g+p,d.r,d.g,d.b,d.a),r(h-m,g+p,h-m,g-p,d.r,d.g,d.b,d.a)}this.device.queue.writeBuffer(this.lineVertexBuffer,0,this.lineVertexData.subarray(0,s*6));const y=t.getCurrentTexture().createView(),v=e.beginRenderPass({colorAttachments:[{view:y,clearValue:this.clearColor,loadOp:"clear",storeOp:"store"}]});v.setPipeline(this.particlePipeline),v.setBindGroup(0,this.particleBindGroup),v.draw(6,n),s>0&&(v.setPipeline(this.linePipeline),v.setBindGroup(0,this.lineBindGroup),v.setVertexBuffer(0,this.lineVertexBuffer),v.draw(s)),v.end()}}const J={useGpuExternalForces:!0,useGpuSpatialHash:!0,useGpuDensity:!0,useGpuDensityReadback:!1,useCpuSpatialDataForGpuDensity:!1,useGpuPressure:!0,useGpuViscosity:!0};class Q{device;context;canvas;config;options;buffers;pipelines;renderer;physics;state;workgroupSize=256;computeData=new Float32Array(8);hashParamsData=new Float32Array(4);sortParamsData=new Uint32Array(4);densityParamsData=new Float32Array(12);pressureParamsData=new Float32Array(12);viscosityParamsData=new Float32Array(12);integrateParamsData=new Float32Array(16);constructor(e,t,i,n,s,r={}){this.device=e,this.context=t,this.canvas=i,this.config=n,this.options={...J,...r},this.pipelines=new N(e),this.renderer=new $(e,s,n),this.reset()}get particleCount(){return this.buffers.particleCount}get simulationState(){return this.state}getScale(){return this.canvas.width/this.config.boundsSize.x}reset(){this.buffers&&this.buffers.destroy();const e=M(this.config);this.state=this.createStateFromSpawn(e),this.buffers=new q(this.device,e),this.physics=T(this.state,this.config,()=>this.getScale()),this.pipelines.createBindGroups(this.buffers),this.renderer.createBindGroup(this.buffers)}refreshSettings(){this.physics.refreshSettings()}createStateFromSpawn(e){return{positions:e.positions,predicted:new Float32Array(e.positions),velocities:e.velocities,densities:new Float32Array(e.count*2),keys:new Uint32Array(e.count),sortedKeys:new Uint32Array(e.count),indices:new Uint32Array(e.count),sortOffsets:new Uint32Array(e.count),spatialOffsets:new Uint32Array(e.count),positionsSorted:new Float32Array(e.count*2),predictedSorted:new Float32Array(e.count*2),velocitiesSorted:new Float32Array(e.count*2),count:e.count,input:{worldX:0,worldY:0,pull:!1,push:!1}}}async step(e){const{options:t,config:i,state:n,buffers:s,pipelines:r,device:a}=this;if(t.useGpuExternalForces){const o=i.maxTimestepFPS?1/i.maxTimestepFPS:Number.POSITIVE_INFINITY,y=Math.min(e*i.timeScale,o)/i.iterationsPerFrame,v=window.devicePixelRatio||1,p=(Math.max(1,Math.round(i.particleRadius))+i.boundsPaddingPx)*v/this.getScale(),h=Math.max(0,i.boundsSize.x*.5-p),g=Math.max(0,i.boundsSize.y*.5-p),d=i.obstacleSize.x>0&&i.obstacleSize.y>0;for(let x=0;x<i.iterationsPerFrame;x++){let B=!1;const G=n.input.push?-i.interactionStrength:n.input.pull?i.interactionStrength:0;this.computeData[0]=y,this.computeData[1]=i.gravity,this.computeData[2]=i.interactionRadius,this.computeData[3]=G,this.computeData[4]=n.input.worldX,this.computeData[5]=n.input.worldY,a.queue.writeBuffer(r.uniformBuffers.compute,0,this.computeData);const l=a.createCommandEncoder(),U=l.beginComputePass();if(U.setPipeline(r.externalForces),U.setBindGroup(0,r.externalForcesBindGroup),U.dispatchWorkgroups(Math.ceil(s.particleCount/this.workgroupSize)),U.end(),(!t.useGpuDensity||t.useCpuSpatialDataForGpuDensity)&&(this.physics.predictPositions(),this.physics.runSpatialHash()),t.useGpuDensity){t.useCpuSpatialDataForGpuDensity?(a.queue.writeBuffer(s.predicted,0,n.predicted),a.queue.writeBuffer(s.sortedKeys,0,n.sortedKeys),a.queue.writeBuffer(s.spatialOffsets,0,n.spatialOffsets)):t.useGpuSpatialHash&&this.dispatchSpatialHash(l),this.updateDensityUniforms();const f=l.beginComputePass();f.setPipeline(r.density),f.setBindGroup(0,r.densityBindGroup),f.dispatchWorkgroups(Math.ceil(s.particleCount/this.workgroupSize)),f.end(),t.useGpuDensityReadback&&(l.copyBufferToBuffer(s.densities,0,s.densityReadback,0,s.particleCount*2*4),B=!0)}else this.physics.calculateDensities(),t.useGpuPressure&&a.queue.writeBuffer(s.densities,0,n.densities);if(t.useGpuPressure){this.updatePressureUniforms(y);const f=l.beginComputePass();f.setPipeline(r.pressure),f.setBindGroup(0,r.pressureBindGroup),f.dispatchWorkgroups(Math.ceil(s.particleCount/this.workgroupSize)),f.end()}else this.physics.calculatePressure(y);if(t.useGpuViscosity){this.updateViscosityUniforms(y);const f=l.beginComputePass();f.setPipeline(r.viscosity),f.setBindGroup(0,r.viscosityBindGroup),f.dispatchWorkgroups(Math.ceil(s.particleCount/this.workgroupSize)),f.end()}else this.physics.calculateViscosity(y);this.updateIntegrateUniforms(y,h,g,d);const O=l.beginComputePass();if(O.setPipeline(r.integrate),O.setBindGroup(0,r.integrateBindGroup),O.dispatchWorkgroups(Math.ceil(s.particleCount/this.workgroupSize)),O.end(),a.queue.submit([l.finish()]),B){await s.densityReadback.mapAsync(GPUMapMode.READ);const f=new Float32Array(s.densityReadback.getMappedRange());n.densities.set(f),s.densityReadback.unmap()}}}else this.physics.step(e);t.useGpuExternalForces||(a.queue.writeBuffer(s.positions,0,n.positions),a.queue.writeBuffer(s.velocities,0,n.velocities),a.queue.writeBuffer(s.predicted,0,n.predicted))}dispatchSpatialHash(e){const{pipelines:t,buffers:i}=this,n=Math.ceil(i.particleCount/this.workgroupSize);this.hashParamsData[0]=this.config.smoothingRadius,this.hashParamsData[1]=i.particleCount,this.device.queue.writeBuffer(t.uniformBuffers.hash,0,this.hashParamsData),this.sortParamsData[0]=i.particleCount,this.device.queue.writeBuffer(t.uniformBuffers.sort,0,this.sortParamsData);const s=e.beginComputePass();s.setPipeline(t.hash),s.setBindGroup(0,t.hashBindGroup),s.dispatchWorkgroups(n),s.end();const r=e.beginComputePass();r.setPipeline(t.clearOffsets),r.setBindGroup(0,t.clearOffsetsBindGroup),r.dispatchWorkgroups(n),r.end();const a=e.beginComputePass();a.setPipeline(t.countOffsets),a.setBindGroup(1,t.countOffsetsBindGroup),a.dispatchWorkgroups(n),a.end();const o=e.beginComputePass();o.setPipeline(t.scatter),o.setBindGroup(0,t.scatterBindGroup),o.dispatchWorkgroups(1),o.end();const c=e.beginComputePass();c.setPipeline(t.spatialOffsets),c.setBindGroup(0,t.spatialOffsetsBindGroup),c.dispatchWorkgroups(1),c.end()}updateDensityUniforms(){const e=this.config.smoothingRadius,t=6/(Math.PI*Math.pow(e,4)),i=10/(Math.PI*Math.pow(e,5));this.densityParamsData[0]=e,this.densityParamsData[1]=t,this.densityParamsData[2]=i,this.densityParamsData[3]=this.buffers.particleCount,this.device.queue.writeBuffer(this.pipelines.uniformBuffers.density,0,this.densityParamsData)}updatePressureUniforms(e){const t=this.config.smoothingRadius,i=12/(Math.PI*Math.pow(t,4)),n=30/(Math.PI*Math.pow(t,5));this.pressureParamsData[0]=e,this.pressureParamsData[1]=this.config.targetDensity,this.pressureParamsData[2]=this.config.pressureMultiplier,this.pressureParamsData[3]=this.config.nearPressureMultiplier,this.pressureParamsData[4]=t,this.pressureParamsData[5]=i,this.pressureParamsData[6]=n,this.pressureParamsData[7]=this.buffers.particleCount,this.device.queue.writeBuffer(this.pipelines.uniformBuffers.pressure,0,this.pressureParamsData)}updateViscosityUniforms(e){const t=this.config.smoothingRadius,i=4/(Math.PI*Math.pow(t,8));this.viscosityParamsData[0]=e,this.viscosityParamsData[1]=this.config.viscosityStrength,this.viscosityParamsData[2]=t,this.viscosityParamsData[3]=i,this.viscosityParamsData[4]=this.buffers.particleCount,this.device.queue.writeBuffer(this.pipelines.uniformBuffers.viscosity,0,this.viscosityParamsData)}updateIntegrateUniforms(e,t,i,n){this.integrateParamsData[0]=e,this.integrateParamsData[1]=this.config.collisionDamping,this.integrateParamsData[2]=n?1:0,this.integrateParamsData[3]=0,this.integrateParamsData[4]=t,this.integrateParamsData[5]=i,this.integrateParamsData[6]=0,this.integrateParamsData[7]=0,this.integrateParamsData[8]=this.config.obstacleCentre.x,this.integrateParamsData[9]=this.config.obstacleCentre.y,this.integrateParamsData[10]=this.config.obstacleSize.x*.5,this.integrateParamsData[11]=this.config.obstacleSize.y*.5,this.device.queue.writeBuffer(this.pipelines.uniformBuffers.integrate,0,this.integrateParamsData)}render(){this.renderer.updateUniforms(this.config,this.canvas.width,this.canvas.height);const e=this.device.createCommandEncoder();this.renderer.render(e,this.context,this.config,this.buffers.particleCount),this.device.queue.submit([e.finish()])}}class w extends Error{constructor(e){super(e),this.name="WebGPUInitError"}}async function ee(u){if(!navigator.gpu)throw new w("WebGPU is not supported in this browser.");const e=await navigator.gpu.requestAdapter();if(!e)throw new w("Unable to acquire a WebGPU adapter.");const t=await e.requestDevice(),i=u.getContext("webgpu");if(!i)throw new w("Unable to create a WebGPU context.");const n=navigator.gpu.getPreferredCanvasFormat();return{device:t,context:i,format:n}}function te(u,e,t){u.configure({device:e,format:t,alphaMode:"opaque"})}function ie(u){u.innerHTML='<canvas id="sim-canvas" aria-label="Fluid simulation"></canvas>';const e=document.querySelector("#sim-canvas");if(!e)throw new Error("Failed to create canvas element");return e}function ne(u,e,t,i){const n=u.getBoundingClientRect(),s=window.devicePixelRatio||1,r=(e-n.left)*s,a=(t-n.top)*s,o=u.width*.5,c=u.height*.5;return{x:(r-o)/i,y:(c-a)/i}}function se(u,e,t){const i=n=>{const s=e();if(!s)return;const r=ne(u,n.clientX,n.clientY,t());s.worldX=r.x,s.worldY=r.y,n.cancelable&&n.preventDefault()};u.addEventListener("pointermove",i),u.addEventListener("pointerdown",n=>{const s=e();s&&(n.cancelable&&n.preventDefault(),i(n),n.button===0&&(s.pull=!0),n.button===2&&(s.push=!0))}),u.addEventListener("pointerup",n=>{const s=e();s&&(n.button===0&&(s.pull=!1),n.button===2&&(s.push=!1))}),u.addEventListener("pointerleave",()=>{const n=e();n&&(n.pull=!1,n.push=!1)}),u.addEventListener("contextmenu",n=>{n.preventDefault()})}function re(u,e,t,i,n){let s=null;const r=()=>{const a=u.getBoundingClientRect();s===null&&(s=e.boundsSize.x/Math.max(1,a.width));const o=window.devicePixelRatio||1,c=Math.max(1,Math.round(a.width*o)),y=Math.max(1,Math.round(a.height*o));(u.width!==c||u.height!==y)&&(u.width=c,u.height=y,e.boundsSize={x:u.width/o*s,y:u.height/o*s},te(t,i,n))};return window.addEventListener("resize",r),r}const _=document.querySelector("#app");if(!_)throw new Error("Missing #app container");const S=ie(_),D=A();D.spawnDensity=100;let b=null,k;const P={paused:!1,togglePause:()=>{P.paused=!P.paused,k&&k.name(P.paused?"Resume":"Pause")},reset:()=>b?.reset()},{stats:C,gui:Y}=z(D,{onReset:()=>b?.reset(),onSmoothingRadiusChange:()=>b?.refreshSettings()},{trackGPU:!0,title:"WebGPU 2D Fluid",subtitle:"SPH Fluid • Particle Simulation",features:["SPH Fluid Simulator (GPU)","WebGPU Compute Pipelines","Bitonic Sort Optimization","Spatial Grid Optimization","High-Performance Rendering"],interactions:["Click & Drag: Pull Particles","Right Click & Drag: Push Particles","Mouse Wheel: Zoom In/Out"],githubUrl:"https://github.com/jeantimex/fluid",buildTimestamp:"2026-04-13T18:26:51.325Z"});k=Y.add(P,"togglePause").name(P.paused?"Resume":"Pause");Y.add(P,"reset").name("Reset Simulation");async function ae(){let u,e,t;try{({device:u,context:e,format:t}=await ee(S))}catch(a){if(a instanceof w){_.innerHTML=`<p>${a.message}</p>`;return}throw a}b=new Q(u,e,S,D,t),se(S,()=>b?.simulationState.input,()=>S.width/D.boundsSize.x),re(S,D,e,u,t)();let s=performance.now();const r=async a=>{C.begin();const o=Math.min(.033,(a-s)/1e3);s=a,P.paused||await b.step(o),b.render(),C.end(),C.update(),requestAnimationFrame(r)};requestAnimationFrame(r)}ae();
