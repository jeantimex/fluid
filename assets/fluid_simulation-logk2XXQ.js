import{p as Q,w as ae,m as ne,e as se,f as re,g as oe,j as le,k as J,F as ce,S as ue,P as de,l as he,n as fe}from"./picking_system-B3C-PV4U.js";import{e as pe}from"./environment-ODazOT3W.js";import{s as me,a as Pe,b as ge}from"./splat_resolve-DUdQ_TmB.js";const ye=`/**
 * ============================================================================
...
`;function Se(H,e){const s=[...H].sort((a,n)=>a.t-n.t),t=new Array(e);for(let a=0;a<e;a+=1){const n=e===1?0:a/(e-1);let i=s[0],r=s[s.length-1];for(let o=0;o<s.length-1;o+=1){const S=s[o],c=s[o+1];if(n>=S.t&&n<=c.t){i=S,r=c;break}}const h=r.t-i.t||1,l=(n-i.t)/h,u=i.r+(r.r-i.r)*l,P=i.g+(r.g-i.g)*l,f=i.b+(r.b-i.b)*l;t[a]={r:u,g:P,b:f}}return t}class Be{device;particlePipeline;facePipeline;backgroundPipeline;shadowParticlePipeline;shadowObstaclePipeline;wireframePipeline;cullPipeline;uniformBuffer;gradientBuffer;envUniformBuffer;camUniformBuffer;shadowUniformBuffer;particleBindGroup;faceBindGroup;backgroundBindGroup;shadowParticleBindGroup;shadowObstacleBindGroup;wireframeBindGroup;cullBindGroup;lineVertexBuffer;lineVertexData;wireframeVertexBuffer;wireframeVertexData;wireframeUniformBuffer;canvas;depthTexture;depthWidth=0;depthHeight=0;shadowTexture;shadowMapSize=2048;shadowSampler;densitySampler;densityUniformBuffer;lastObstacleParams="";lastWireframeParams="";lastEnvParams="";lastFaceCount=0;lastWireframeVertexCount=0;constructor(e,s,t,a){this.device=e,this.canvas=s,this.uniformBuffer=e.createBuffer({size:112,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.envUniformBuffer=e.createBuffer({size:240,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.camUniformBuffer=e.createBuffer({size:80,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.densityUniformBuffer=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.shadowUniformBuffer=e.createBuffer({size:96,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});const n=Se(a.colorKeys,a.gradientResolution),i=new Float32Array(a.gradientResolution*4);for(let d=0;d<n.length;d++)i[d*4]=n[d].r,i[d*4+1]=n[d].g,i[d*4+2]=n[d].b,i[d*4+3]=1;this.gradientBuffer=e.createBuffer({size:i.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,mappedAtCreation:!0}),new Float32Array(this.gradientBuffer.getMappedRange()).set(i),this.gradientBuffer.unmap();const r=Q(ye,{"../../common/shaders/shadow_common.wgsl":J}),h=e.createShaderModule({code:r});this.particlePipeline=e.createRenderPipeline({layout:"auto",vertex:{module:h,entryPoint:"vs_main"},fragment:{module:h,entryPoint:"fs_main",targets:[{format:t}]},primitive:{topology:"triangle-list"},depthStencil:{format:"depth24plus",depthWriteEnabled:!0,depthCompare:"less"}});const l=Q(xe,{"../../common/shaders/shadow_common.wgsl":J}),u=e.createShaderModule({code:l});this.facePipeline=e.createRenderPipeline({layout:"auto",vertex:{module:u,entryPoint:"vs_main",buffers:[{arrayStride:40,attributes:[{shaderLocation:0,offset:0,format:"float32x3"},{shaderLocation:1,offset:12,format:"float32x3"},{shaderLocation:2,offset:24,format:"float32x4"}]}]},fragment:{module:u,entryPoint:"fs_main",targets:[{format:t,blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one-minus-src-alpha",operation:"add"}}}]},primitive:{topology:"triangle-list",cullMode:"back"},depthStencil:{format:"depth24plus",depthWriteEnabled:!1,depthCompare:"less"}});const P=Q(ve,{"../../common/shaders/environment.wgsl":pe,"../../common/shaders/shadow_common.wgsl":J}),f=e.createShaderModule({code:P});this.backgroundPipeline=e.createRenderPipeline({layout:"auto",vertex:{module:f,entryPoint:"vs_main"},fragment:{module:f,entryPoint:"fs_main",targets:[{format:t}]},primitive:{topology:"triangle-list"},depthStencil:{format:"depth24plus",depthWriteEnabled:!1,depthCompare:"always"}});const o=Q(we,{"shadow_common.wgsl":J}),S=e.createShaderModule({code:o});this.shadowParticlePipeline=e.createRenderPipeline({layout:"auto",vertex:{module:S,entryPoint:"vs_particles"},primitive:{topology:"triangle-list",cullMode:"none"},depthStencil:{format:"depth24plus",depthWriteEnabled:!0,depthCompare:"less"}}),this.shadowObstaclePipeline=e.createRenderPipeline({layout:"auto",vertex:{module:S,entryPoint:"vs_obstacle",buffers:[{arrayStride:40,attributes:[{shaderLocation:0,offset:0,format:"float32x3"}]}]},primitive:{topology:"triangle-list",cullMode:"back"},depthStencil:{format:"depth24plus",depthWriteEnabled:!0,depthCompare:"less"}});const c=e.createShaderModule({code:be});this.cullPipeline=e.createComputePipeline({layout:"auto",compute:{module:c,entryPoint:"main"}});const g=e.createShaderModule({code:ae});this.wireframePipeline=e.createRenderPipeline({layout:"auto",vertex:{module:g,entryPoint:"vs_main",buffers:[{arrayStride:28,attributes:[{shaderLocation:0,offset:0,format:"float32x3"},{shaderLocation:1,offset:12,format:"float32x4"}]}]},fragment:{module:g,entryPoint:"fs_main",targets:[{format:t}]},primitive:{topology:"line-list"},depthStencil:{format:"depth24plus",depthWriteEnabled:!0,depthCompare:"less"}}),this.wireframeUniformBuffer=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.wireframeVertexData=new Float32Array(168),this.wireframeVertexBuffer=e.createBuffer({size:this.wireframeVertexData.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});const x=384*6,B=Math.max(36,x)*10;this.lineVertexData=new Float32Array(B),this.lineVertexBuffer=e.createBuffer({size:this.lineVertexData.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),this.shadowTexture=this.device.createTexture({size:[this.shadowMapSize,this.shadowMapSize],format:"depth24plus",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),this.shadowSampler=this.device.createSampler({compare:"less",magFilter:"linear",minFilter:"linear"}),this.faceBindGroup=e.createBindGroup({layout:this.facePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.uniformBuffer}},{binding:1,resource:this.shadowTexture.createView()},{binding:2,resource:this.shadowSampler},{binding:3,resource:{buffer:this.shadowUniformBuffer}}]}),this.shadowObstacleBindGroup=e.createBindGroup({layout:this.shadowObstaclePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.shadowUniformBuffer}}]}),this.wireframeBindGroup=e.createBindGroup({layout:this.wireframePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.wireframeUniformBuffer}}]}),this.densitySampler=this.device.createSampler({addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",addressModeW:"clamp-to-edge",magFilter:"linear",minFilter:"linear"}),this.resize()}resize(){const e=this.canvas.width,s=this.canvas.height;this.depthTexture&&e===this.depthWidth&&s===this.depthHeight||(this.depthTexture&&this.depthTexture.destroy(),this.depthTexture=this.device.createTexture({size:[e,s],format:"depth24plus",usage:GPUTextureUsage.RENDER_ATTACHMENT}),this.depthWidth=e,this.depthHeight=s)}createBindGroup(e,s,t){this.particleBindGroup=this.device.createBindGroup({layout:this.particlePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:e.positions}},{binding:1,resource:{buffer:e.velocities}},{binding:2,resource:{buffer:this.uniformBuffer}},{binding:3,resource:{buffer:this.gradientBuffer}},{binding:4,resource:{buffer:e.visibleIndices}},{binding:5,resource:this.shadowTexture.createView()},{binding:6,resource:this.shadowSampler},{binding:7,resource:{buffer:this.shadowUniformBuffer}}]}),this.shadowParticleBindGroup=this.device.createBindGroup({layout:this.shadowParticlePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.shadowUniformBuffer}},{binding:1,resource:{buffer:e.positions}},{binding:2,resource:{buffer:e.visibleIndices}}]}),this.cullBindGroup=this.device.createBindGroup({layout:this.cullPipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:e.positions}},{binding:1,resource:{buffer:e.visibleIndices}},{binding:2,resource:{buffer:e.indirectDraw}},{binding:3,resource:{buffer:t}}]}),this.backgroundBindGroup=this.device.createBindGroup({layout:this.backgroundPipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.envUniformBuffer}},{binding:1,resource:{buffer:this.camUniformBuffer}},{binding:2,resource:s},{binding:3,resource:this.densitySampler},{binding:4,resource:{buffer:this.densityUniformBuffer}},{binding:5,resource:this.shadowTexture.createView()},{binding:6,resource:this.shadowSampler},{binding:7,resource:{buffer:this.shadowUniformBuffer}}]})}buildObstacleGeometry(e){const s=e.obstacleShape??"box",t=e.obstacleColor??{r:1,g:0,b:0},a=e.obstacleAlpha??.8;if(s==="sphere"){const m=e.obstacleRadius??0;if(m<=0)return{faceCount:0};const b=e.obstacleCentre.x,I=e.obstacleCentre.y,F=e.obstacleCentre.z;let y=0;const O=(V,_)=>{this.lineVertexData[y++]=V[0],this.lineVertexData[y++]=V[1],this.lineVertexData[y++]=V[2],this.lineVertexData[y++]=_[0],this.lineVertexData[y++]=_[1],this.lineVertexData[y++]=_[2],this.lineVertexData[y++]=t.r,this.lineVertexData[y++]=t.g,this.lineVertexData[y++]=t.b,this.lineVertexData[y++]=a},C=16,z=24;for(let V=0;V<C;V++){const _=V/C,te=(V+1)/C,N=_*Math.PI,k=te*Math.PI;for(let M=0;M<z;M++){const X=M/z,Z=(M+1)/z,L=X*Math.PI*2,q=Z*Math.PI*2,W=[Math.sin(N)*Math.cos(L),Math.cos(N),Math.sin(N)*Math.sin(L)],A=[Math.sin(N)*Math.cos(q),Math.cos(N),Math.sin(N)*Math.sin(q)],v=[Math.sin(k)*Math.cos(L),Math.cos(k),Math.sin(k)*Math.sin(L)],T=[Math.sin(k)*Math.cos(q),Math.cos(k),Math.sin(k)*Math.sin(q)],Y=K=>{const ie=K;O([K[0]*m+b,K[1]*m+I,K[2]*m+F],ie)};Y(W),Y(T),Y(v),Y(W),Y(A),Y(T)}}return{faceCount:C*z*6}}const n=e.obstacleSize.x*.5,i=e.obstacleSize.y*.5,r=e.obstacleSize.z*.5;if(n<=0||i<=0||r<=0)return{faceCount:0};const h=e.obstacleCentre.x,l=e.obstacleCentre.y+e.obstacleSize.y*.5,u=e.obstacleCentre.z,P=Math.PI/180,f=e.obstacleRotation.x*P,o=e.obstacleRotation.y*P,S=e.obstacleRotation.z*P,c=Math.cos(f),g=Math.sin(f),x=Math.cos(o),B=Math.sin(o),d=Math.cos(S),R=Math.sin(S),D=(m,b,I)=>{const F=b*c-I*g,y=b*g+I*c,O=m*x+y*B,C=-m*B+y*x,z=O*d-F*R,$=O*R+F*d;return[z+h,$+l,C+u]},E=[D(-n,-i,-r),D(+n,-i,-r),D(+n,+i,-r),D(-n,+i,-r),D(-n,-i,+r),D(+n,-i,+r),D(+n,+i,+r),D(-n,+i,+r)],G=(m,b,I)=>{const F=b*c-I*g,y=b*g+I*c,O=m*x+y*B,C=-m*B+y*x,z=O*d-F*R,$=O*R+F*d;return[z,$,C]},j=[G(0,0,-1),G(0,0,1),G(-1,0,0),G(1,0,0),G(0,-1,0),G(0,1,0)];let U=0;const ee=(m,b)=>{this.lineVertexData[U++]=m[0],this.lineVertexData[U++]=m[1],this.lineVertexData[U++]=m[2],this.lineVertexData[U++]=b[0],this.lineVertexData[U++]=b[1],this.lineVertexData[U++]=b[2],this.lineVertexData[U++]=t.r,this.lineVertexData[U++]=t.g,this.lineVertexData[U++]=t.b,this.lineVertexData[U++]=a},p=[[0,2,1,0,3,2],[4,5,6,4,6,7],[0,4,7,0,7,3],[1,2,6,1,6,5],[0,1,5,0,5,4],[3,7,6,3,6,2]];for(let m=0;m<p.length;m++){const b=j[m];for(const I of p[m])ee(E[I],b)}return{faceCount:36}}buildBoundsWireframe(e,s){const t=s.x*.5,a=s.y*.5,n=s.z*.5,i=a-5,r=e.boundsWireframeColor??{r:1,g:1,b:1},h=[[-t,i-a,-n],[+t,i-a,-n],[+t,i+a,-n],[-t,i+a,-n],[-t,i-a,+n],[+t,i-a,+n],[+t,i+a,+n],[-t,i+a,+n]],l=[[0,1],[1,5],[5,4],[4,0],[3,2],[2,6],[6,7],[7,3],[0,3],[1,2],[5,6],[4,7]];let u=0;const P=f=>{const o=h[f];this.wireframeVertexData[u++]=o[0],this.wireframeVertexData[u++]=o[1],this.wireframeVertexData[u++]=o[2],this.wireframeVertexData[u++]=r.r,this.wireframeVertexData[u++]=r.g,this.wireframeVertexData[u++]=r.b,this.wireframeVertexData[u++]=1};for(const[f,o]of l)P(f),P(o);return l.length*2}render(e,s,t,a,n,i){const r=i??t.boundsSize,h=t.obstacleColor??{r:1,g:0,b:0},l=t.obstacleAlpha??.8,u=e.beginComputePass();u.setPipeline(this.cullPipeline),u.setBindGroup(0,this.cullBindGroup),u.dispatchWorkgroups(Math.ceil(a.particleCount/256)),u.end();const P=this.canvas.width/this.canvas.height,f=ne(Math.PI/3,P,.1,100),o=se(f,n),S=window.devicePixelRatio||1,c=new Float32Array(28);c.set(o),c[16]=this.canvas.width,c[17]=this.canvas.height,c[18]=t.particleRadius*S,c[19]=t.velocityDisplayMax,c[20]=t.sceneExposure,c[21]=t.floorAmbient,c[22]=t.sunBrightness,c[23]=0,c[24]=t.dirToSun.x,c[25]=t.dirToSun.y,c[26]=t.dirToSun.z,c[27]=0,this.device.queue.writeBuffer(this.uniformBuffer,0,c);const g=`${t.globalBrightness}-${t.globalSaturation}-${t.floorAmbient}-${t.sunBrightness}-${t.dirToSun.x}-${t.dirToSun.y}-${t.dirToSun.z}-${h.r}-${h.g}-${h.b}-${l}-${t.tileCol1.r}-${t.tileCol1.g}-${t.tileCol1.b}-${t.tileCol2.r}-${t.tileCol2.g}-${t.tileCol2.b}-${t.tileCol3.r}-${t.tileCol3.g}-${t.tileCol3.b}-${t.tileCol4.r}-${t.tileCol4.g}-${t.tileCol4.b}-${t.skyColorHorizon.r}-${t.skyColorHorizon.g}-${t.skyColorHorizon.b}-${t.skyColorZenith.r}-${t.skyColorZenith.g}-${t.skyColorZenith.b}-${t.skyColorGround.r}-${t.skyColorGround.g}-${t.skyColorGround.b}`;if(g!==this.lastEnvParams){const T=new Float32Array(60);re(T,0,t,t),this.device.queue.writeBuffer(this.envUniformBuffer,0,T),this.lastEnvParams=g}const x={x:n[0],y:n[4],z:n[8]},B={x:n[1],y:n[5],z:n[9]},d={x:n[2],y:n[6],z:n[10]},R={x:-d.x,y:-d.y,z:-d.z},D=n[12],E=n[13],G=n[14],j=-(x.x*D+B.x*E+d.x*G),U=-(x.y*D+B.y*E+d.y*G),ee=-(x.z*D+B.z*E+d.z*G),p=new Float32Array(20);p[0]=j,p[1]=U,p[2]=ee,p[3]=0,p[4]=R.x,p[5]=R.y,p[6]=R.z,p[7]=0,p[8]=x.x,p[9]=x.y,p[10]=x.z,p[11]=0,p[12]=B.x,p[13]=B.y,p[14]=B.z,p[15]=0,p[16]=Math.PI/3,p[17]=P,this.device.queue.writeBuffer(this.camUniformBuffer,0,p);const w=new Float32Array(16),m=r.x*.5,b=r.z*.5,I=-5;w[0]=-m,w[1]=I,w[2]=-b,w[3]=0,w[4]=m,w[5]=I+r.y,w[6]=b,w[7]=0,w[8]=t.densityOffset,w[9]=t.densityMultiplier,w[10]=t.lightStepSize,w[11]=t.shadowSoftness,w[12]=t.extinctionCoefficients.x,w[13]=t.extinctionCoefficients.y,w[14]=t.extinctionCoefficients.z,w[15]=0,this.device.queue.writeBuffer(this.densityUniformBuffer,0,w);const F=r,y=t.floorSize,O=t.dirToSun,C=Math.max(F.x+F.z,y.x+y.z),z=C*.6,$={x:O.x*C,y:O.y*C,z:O.z*C},V=oe($,{x:0,y:0,z:0},{x:0,y:1,z:0}),_=le(-z,z,-z,z,.1,-C*3),te=se(_,V),k=Math.max(.001,t.smoothingRadius)/z,M=new Float32Array(20);M.set(te),M[16]=t.shadowSoftness??1,M[17]=k,M[18]=0,M[19]=0,this.device.queue.writeBuffer(this.shadowUniformBuffer,0,M);const X=t.showObstacle!==!1,Z=`${X}-${t.obstacleShape}-${t.obstacleSize.x}-${t.obstacleSize.y}-${t.obstacleSize.z}-${t.obstacleCentre.x}-${t.obstacleCentre.y}-${t.obstacleCentre.z}-${t.obstacleRotation.x}-${t.obstacleRotation.y}-${t.obstacleRotation.z}-${t.obstacleRadius}-${h.r}-${h.g}-${h.b}-${l}`;if(Z!==this.lastObstacleParams){const{faceCount:T}=X?this.buildObstacleGeometry(t):{faceCount:0};this.lastFaceCount=T,T>0&&this.device.queue.writeBuffer(this.lineVertexBuffer,0,this.lineVertexData.buffer,this.lineVertexData.byteOffset,T*10*4),this.lastObstacleParams=Z}const L=this.lastFaceCount,q=`${t.showBoundsWireframe}-${r.x.toFixed(3)}-${r.y.toFixed(3)}-${r.z.toFixed(3)}-${t.boundsWireframeColor.r}-${t.boundsWireframeColor.g}-${t.boundsWireframeColor.b}`;if(q!==this.lastWireframeParams){let T=0;t.showBoundsWireframe&&(T=this.buildBoundsWireframe(t,r),this.device.queue.writeBuffer(this.wireframeVertexBuffer,0,this.wireframeVertexData.buffer,this.wireframeVertexData.byteOffset,T*7*4)),this.lastWireframeVertexCount=T,this.lastWireframeParams=q}const W=this.lastWireframeVertexCount;t.showBoundsWireframe&&W>0&&this.device.queue.writeBuffer(this.wireframeUniformBuffer,0,o.buffer,o.byteOffset,o.byteLength);const A=e.beginRenderPass({colorAttachments:[],depthStencilAttachment:{view:this.shadowTexture.createView(),depthClearValue:1,depthLoadOp:"clear",depthStoreOp:"store"}});A.setPipeline(this.shadowParticlePipeline),A.setBindGroup(0,this.shadowParticleBindGroup),t.showFluidShadows&&A.drawIndirect(a.indirectDraw,0),L>0&&(A.setPipeline(this.shadowObstaclePipeline),A.setBindGroup(0,this.shadowObstacleBindGroup),A.setVertexBuffer(0,this.lineVertexBuffer,0),A.draw(L)),A.end();const v=e.beginRenderPass({colorAttachments:[{view:s,clearValue:{r:.05,g:.05,b:.08,a:1},loadOp:"clear",storeOp:"store"}],depthStencilAttachment:{view:this.depthTexture.createView(),depthClearValue:1,depthLoadOp:"clear",depthStoreOp:"store"}});v.setPipeline(this.backgroundPipeline),v.setBindGroup(0,this.backgroundBindGroup),v.draw(3,1,0,0),v.setPipeline(this.particlePipeline),v.setBindGroup(0,this.particleBindGroup),v.drawIndirect(a.indirectDraw,0),L>0&&(v.setPipeline(this.facePipeline),v.setBindGroup(0,this.faceBindGroup),v.setVertexBuffer(0,this.lineVertexBuffer,0),v.draw(L)),t.showBoundsWireframe&&W>0&&(v.setPipeline(this.wireframePipeline),v.setBindGroup(0,this.wireframeBindGroup),v.setVertexBuffer(0,this.wireframeVertexBuffer,0),v.draw(W)),v.end()}}class De{device;clearPipeline;particlesPipeline;resolvePipeline;clearBindGroup;particlesBindGroup;resolveBindGroup;clearParamsBuffer;particlesParamsBuffer;resolveParamsBuffer;particlesParamsData;particlesParamsF32;particlesParamsU32;resolveParamsData;resolveParamsF32;resolveParamsU32;atomicDensityBuffer;densityTexture;_densityTextureView;densityTextureSize={x:1,y:1,z:1};densityWorkgroupSize={x:8,y:8,z:4};constructor(e){this.device=e;const s=e.createShaderModule({code:me});this.clearPipeline=e.createComputePipeline({layout:"auto",compute:{module:s,entryPoint:"main"}}),this.clearParamsBuffer=e.createBuffer({size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});const t=e.createShaderModule({code:Pe});this.particlesPipeline=e.createComputePipeline({layout:"auto",compute:{module:t,entryPoint:"main"}}),this.particlesParamsData=new ArrayBuffer(64),this.particlesParamsF32=new Float32Array(this.particlesParamsData),this.particlesParamsU32=new Uint32Array(this.particlesParamsData),this.particlesParamsBuffer=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});const a=e.createShaderModule({code:ge});this.resolvePipeline=e.createComputePipeline({layout:"auto",compute:{module:a,entryPoint:"main"}}),this.resolveParamsData=new ArrayBuffer(32),this.resolveParamsF32=new Float32Array(this.resolveParamsData),this.resolveParamsU32=new Uint32Array(this.resolveParamsData),this.resolveParamsBuffer=e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}get textureView(){return this._densityTextureView}recreate(e,s){this.densityTexture&&this.densityTexture.destroy(),this.createDensityTexture(e),this.createAtomicDensityBuffer(),this.createBindGroups(s)}dispatch(e,s,t){this.updateParams(s,t);const a=this.densityTextureSize.x*this.densityTextureSize.y*this.densityTextureSize.z,n=e.beginComputePass();n.setPipeline(this.clearPipeline),n.setBindGroup(0,this.clearBindGroup),n.dispatchWorkgroups(Math.ceil(a/256)),n.end();const i=e.beginComputePass();i.setPipeline(this.particlesPipeline),i.setBindGroup(0,this.particlesBindGroup),i.dispatchWorkgroups(Math.ceil(s/256)),i.end();const r=e.beginComputePass();r.setPipeline(this.resolvePipeline),r.setBindGroup(0,this.resolveBindGroup),r.dispatchWorkgroups(Math.ceil(this.densityTextureSize.x/this.densityWorkgroupSize.x),Math.ceil(this.densityTextureSize.y/this.densityWorkgroupSize.y),Math.ceil(this.densityTextureSize.z/this.densityWorkgroupSize.z)),r.end()}destroy(){this.densityTexture&&this.densityTexture.destroy(),this.atomicDensityBuffer&&this.atomicDensityBuffer.destroy()}createDensityTexture(e){const s=e.boundsSize,t=Math.max(s.x,s.y,s.z),a=Math.max(1,Math.round(e.densityTextureRes)),n=Math.max(1,Math.round(s.x/t*a)),i=Math.max(1,Math.round(s.y/t*a)),r=Math.max(1,Math.round(s.z/t*a));this.densityTextureSize={x:n,y:i,z:r},this.densityTexture=this.device.createTexture({size:{width:n,height:i,depthOrArrayLayers:r},dimension:"3d",format:"rgba16float",usage:GPUTextureUsage.STORAGE_BINDING|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC}),this._densityTextureView=this.densityTexture.createView({dimension:"3d"})}createAtomicDensityBuffer(){this.atomicDensityBuffer&&this.atomicDensityBuffer.destroy();const e=this.densityTextureSize.x*this.densityTextureSize.y*this.densityTextureSize.z;this.atomicDensityBuffer=this.device.createBuffer({size:e*4,usage:GPUBufferUsage.STORAGE})}createBindGroups(e){this.clearBindGroup=this.device.createBindGroup({layout:this.clearPipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.atomicDensityBuffer}},{binding:1,resource:{buffer:this.clearParamsBuffer}}]}),this.particlesBindGroup=this.device.createBindGroup({layout:this.particlesPipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:e}},{binding:1,resource:{buffer:this.atomicDensityBuffer}},{binding:2,resource:{buffer:this.particlesParamsBuffer}}]}),this.resolveBindGroup=this.device.createBindGroup({layout:this.resolvePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.atomicDensityBuffer}},{binding:1,resource:this._densityTextureView},{binding:2,resource:{buffer:this.resolveParamsBuffer}}]})}updateParams(e,s){const t=s.smoothingRadius,a=15/(2*Math.PI*Math.pow(t,5)),n=1e3,i=this.densityTextureSize.x*this.densityTextureSize.y*this.densityTextureSize.z,r=s.boundsSize,h=r.x*.5,l=r.z*.5,u=-5,P=s.densityTextureRes/Math.max(r.x,r.y,r.z),f=new Uint32Array(4);f[0]=i,this.device.queue.writeBuffer(this.clearParamsBuffer,0,f),this.particlesParamsF32[0]=t,this.particlesParamsF32[1]=a,this.particlesParamsU32[2]=e,this.particlesParamsF32[3]=n,this.particlesParamsF32[4]=-h,this.particlesParamsF32[5]=u,this.particlesParamsF32[6]=-l,this.particlesParamsF32[7]=P,this.particlesParamsF32[8]=h,this.particlesParamsF32[9]=u+r.y,this.particlesParamsF32[10]=l,this.particlesParamsF32[11]=0,this.particlesParamsU32[12]=this.densityTextureSize.x,this.particlesParamsU32[13]=this.densityTextureSize.y,this.particlesParamsU32[14]=this.densityTextureSize.z,this.particlesParamsU32[15]=0,this.device.queue.writeBuffer(this.particlesParamsBuffer,0,this.particlesParamsData),this.resolveParamsF32[0]=n,this.resolveParamsF32[1]=0,this.resolveParamsF32[2]=0,this.resolveParamsF32[3]=0,this.resolveParamsU32[4]=this.densityTextureSize.x,this.resolveParamsU32[5]=this.densityTextureSize.y,this.resolveParamsU32[6]=this.densityTextureSize.z,this.resolveParamsU32[7]=0,this.device.queue.writeBuffer(this.resolveParamsBuffer,0,this.resolveParamsData)}}class Te{device;context;config;buffers;physics;grid;renderer;splatPipeline;pickingSystem;state;gridRes={x:0,y:0,z:0};gridTotalCells=0;isPicking=!1;interactionPos={x:0,y:0,z:0};smoothBoundsSize={x:0,y:0,z:0};physicsUniforms;gridUniforms;cullUniformBuffer;computeData=new Float32Array(8);integrateData=new Float32Array(24);hashParamsData=new Float32Array(8);sortParamsData=new Uint32Array(8);scanParamsDataL0=new Uint32Array(4);scanParamsDataL1=new Uint32Array(4);scanParamsDataL2=new Uint32Array(4);densityParamsData=new Float32Array(12);pressureParamsData=new Float32Array(16);viscosityParamsData=new Float32Array(12);cullParamsData=new Float32Array(20);indirectArgs=new Uint32Array([6,0,0,0]);constructor(e,s,t,a,n,i=!1,r=!1){this.device=e,this.context=s,this.config=a,this.physics=new ce(e,r),this.grid=new ue(e,i),this.renderer=new Be(e,t,n,a),this.splatPipeline=new De(e),this.pickingSystem=new de(e),this.physicsUniforms={external:e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),density:e.createBuffer({size:48,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),pressure:e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),viscosity:e.createBuffer({size:48,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),integrate:e.createBuffer({size:96,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})},this.gridUniforms={hash:e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),sort:e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),scanL0:e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),scanL1:e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),scanL2:e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})},this.cullUniformBuffer=e.createBuffer({size:80,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.reset()}get particleCount(){return this.buffers.particleCount}get simulationState(){return this.state}reset(){this.buffers&&this.buffers.destroy();const{boundsSize:e,smoothingRadius:s}=this.config;this.smoothBoundsSize.x=e.x,this.smoothBoundsSize.y=e.y,this.smoothBoundsSize.z=e.z,this.gridRes={x:Math.ceil(e.x/s),y:Math.ceil(e.y/s),z:Math.ceil(e.z/s)},this.gridTotalCells=this.gridRes.x*this.gridRes.y*this.gridRes.z;const t=he(this.config);this.state=this.createStateFromSpawn(t),this.buffers=new fe(this.device,t,{gridTotalCells:this.gridTotalCells}),this.physics.createBindGroups(this.buffers,this.physicsUniforms),this.grid.createBindGroups(this.buffers,this.gridUniforms),this.splatPipeline.recreate(this.config,this.buffers.predicted),this.pickingSystem.createBindGroup(this.buffers.positions),this.renderer.createBindGroup(this.buffers,this.splatPipeline.textureView,this.cullUniformBuffer);const a=this.device.createCommandEncoder();this.splatPipeline.dispatch(a,this.buffers.particleCount,this.config),this.device.queue.submit([a.finish()])}createStateFromSpawn(e){return{positions:e.positions,predicted:new Float32Array(e.positions),velocities:e.velocities,densities:new Float32Array(e.count*2),keys:new Uint32Array(e.count),sortedKeys:new Uint32Array(e.count),indices:new Uint32Array(e.count),sortOffsets:new Uint32Array(e.count),spatialOffsets:new Uint32Array(e.count),positionsSorted:new Float32Array(e.count*4),predictedSorted:new Float32Array(e.count*4),velocitiesSorted:new Float32Array(e.count*4),count:e.count,input:{worldX:0,worldY:0,worldZ:0,pull:!1,push:!1}}}async step(e){const{config:s,buffers:t,device:a}=this,n=.1;this.smoothBoundsSize.x+=(s.boundsSize.x-this.smoothBoundsSize.x)*n,this.smoothBoundsSize.y+=(s.boundsSize.y-this.smoothBoundsSize.y)*n,this.smoothBoundsSize.z+=(s.boundsSize.z-this.smoothBoundsSize.z)*n;const i=s.maxTimestepFPS?1/s.maxTimestepFPS:Number.POSITIVE_INFINITY,h=Math.min(e*s.timeScale,i)/s.iterationsPerFrame;this.updateUniforms(h);const l=a.createCommandEncoder();let u=!1;!this.isPicking&&this.state.input.rayOrigin&&this.state.input.rayDir&&(this.isPicking=!0,u=!0,this.pickingSystem.dispatch(l,this.state.input.rayOrigin,this.state.input.rayDir,s.smoothingRadius,t.particleCount));const P=l.beginComputePass();for(let o=0;o<s.iterationsPerFrame;o++)this.physics.step(P,this.grid,t.particleCount,this.gridTotalCells,s.viscosityStrength>0,o===0);P.end(),s.showFluidShadows&&this.splatPipeline.dispatch(l,t.particleCount,s),a.queue.submit([l.finish()]),u&&this.pickingSystem.getResult().then(o=>{if(o&&o.hit){let S=o.hitPos.x,c=o.hitPos.y,g=o.hitPos.z;this.state.input.pull&&this.state.input.rayDir&&(S+=this.state.input.rayDir.x*.5,c+=this.state.input.rayDir.y*.5,g+=this.state.input.rayDir.z*.5),this.state.input.worldX=S,this.state.input.worldY=c,this.state.input.worldZ=g,this.state.input.isHoveringFluid=!0}else this.state.input.isHoveringFluid=!1;this.isPicking=!1});const f=.15;this.interactionPos.x+=(this.state.input.worldX-this.interactionPos.x)*f,this.interactionPos.y+=(this.state.input.worldY-this.interactionPos.y)*f,this.interactionPos.z+=(this.state.input.worldZ-this.interactionPos.z)*f}updateUniforms(e){const{config:s,state:t,buffers:a,device:n}=this;let i=0;t.input.push?i=-s.interactionStrength:t.input.pull&&(i=s.interactionStrength),this.computeData[0]=e,this.computeData[1]=s.gravity,this.computeData[2]=s.interactionRadius,this.computeData[3]=i,this.computeData[4]=this.interactionPos.x,this.computeData[5]=this.interactionPos.y,this.computeData[6]=this.interactionPos.z,this.computeData[7]=0,n.queue.writeBuffer(this.physicsUniforms.external,0,this.computeData),this.hashParamsData[0]=s.smoothingRadius,this.hashParamsData[1]=a.particleCount,this.hashParamsData[2]=-this.smoothBoundsSize.x*.5,this.hashParamsData[3]=-5,this.hashParamsData[4]=-this.smoothBoundsSize.z*.5,this.hashParamsData[5]=this.gridRes.x,this.hashParamsData[6]=this.gridRes.y,this.hashParamsData[7]=this.gridRes.z,n.queue.writeBuffer(this.gridUniforms.hash,0,this.hashParamsData),this.sortParamsData[0]=a.particleCount,this.sortParamsData[1]=this.gridTotalCells,n.queue.writeBuffer(this.gridUniforms.sort,0,this.sortParamsData);const r=Math.ceil((this.gridTotalCells+1)/512),h=Math.ceil(r/512);this.scanParamsDataL0[0]=this.gridTotalCells+1,this.scanParamsDataL1[0]=r,this.scanParamsDataL2[0]=h,n.queue.writeBuffer(this.gridUniforms.scanL0,0,this.scanParamsDataL0),n.queue.writeBuffer(this.gridUniforms.scanL1,0,this.scanParamsDataL1),n.queue.writeBuffer(this.gridUniforms.scanL2,0,this.scanParamsDataL2);const l=s.smoothingRadius,u=15/(2*Math.PI*Math.pow(l,5)),P=15/(Math.PI*Math.pow(l,6));this.densityParamsData[0]=l,this.densityParamsData[1]=u,this.densityParamsData[2]=P,this.densityParamsData[3]=a.particleCount,this.densityParamsData[4]=-this.smoothBoundsSize.x*.5,this.densityParamsData[5]=-5,this.densityParamsData[6]=-this.smoothBoundsSize.z*.5,this.densityParamsData[7]=0,this.densityParamsData[8]=this.gridRes.x,this.densityParamsData[9]=this.gridRes.y,this.densityParamsData[10]=this.gridRes.z,this.densityParamsData[11]=0,n.queue.writeBuffer(this.physicsUniforms.density,0,this.densityParamsData);const f=15/(Math.PI*Math.pow(l,5)),o=45/(Math.PI*Math.pow(l,6));this.pressureParamsData[0]=e,this.pressureParamsData[1]=s.targetDensity,this.pressureParamsData[2]=s.pressureMultiplier,this.pressureParamsData[3]=s.nearPressureMultiplier,this.pressureParamsData[4]=l,this.pressureParamsData[5]=f,this.pressureParamsData[6]=o,this.pressureParamsData[7]=a.particleCount,this.pressureParamsData[8]=-this.smoothBoundsSize.x*.5,this.pressureParamsData[9]=-5,this.pressureParamsData[10]=-this.smoothBoundsSize.z*.5,this.pressureParamsData[11]=0,this.pressureParamsData[12]=this.gridRes.x,this.pressureParamsData[13]=this.gridRes.y,this.pressureParamsData[14]=this.gridRes.z,this.pressureParamsData[15]=0,n.queue.writeBuffer(this.physicsUniforms.pressure,0,this.pressureParamsData);const S=315/(64*Math.PI*Math.pow(l,9));this.viscosityParamsData[0]=e,this.viscosityParamsData[1]=s.viscosityStrength,this.viscosityParamsData[2]=l,this.viscosityParamsData[3]=S,this.viscosityParamsData[4]=a.particleCount,this.viscosityParamsData[5]=-this.smoothBoundsSize.x*.5,this.viscosityParamsData[6]=-5,this.viscosityParamsData[7]=-this.smoothBoundsSize.z*.5,this.viscosityParamsData[8]=this.gridRes.x,this.viscosityParamsData[9]=this.gridRes.y,this.viscosityParamsData[10]=this.gridRes.z,this.viscosityParamsData[11]=0,n.queue.writeBuffer(this.physicsUniforms.viscosity,0,this.viscosityParamsData),this.integrateData[0]=e,this.integrateData[1]=s.collisionDamping;const g=(s.obstacleShape??"box")==="sphere",x=s.obstacleRadius??0,B=s.showObstacle!==!1&&(g?x>0:s.obstacleSize.x>0&&s.obstacleSize.y>0&&s.obstacleSize.z>0);this.integrateData[2]=B?1:0,this.integrateData[3]=g?1:0;const d=this.smoothBoundsSize,R=d.x*.5,D=d.z*.5,E=-5;this.integrateData[4]=-R,this.integrateData[5]=E,this.integrateData[6]=-D,this.integrateData[8]=R,this.integrateData[9]=E+d.y,this.integrateData[10]=D,this.integrateData[12]=s.obstacleCentre.x,this.integrateData[13]=g?s.obstacleCentre.y:s.obstacleCentre.y+s.obstacleSize.y*.5,this.integrateData[14]=s.obstacleCentre.z;const G=g?x:s.obstacleSize.x*.5,j=g?x:s.obstacleSize.y*.5,U=g?x:s.obstacleSize.z*.5;this.integrateData[16]=G,this.integrateData[17]=j,this.integrateData[18]=U,this.integrateData[20]=s.obstacleRotation.x,this.integrateData[21]=s.obstacleRotation.y,this.integrateData[22]=s.obstacleRotation.z,n.queue.writeBuffer(this.physicsUniforms.integrate,0,this.integrateData)}render(e){const{device:s,buffers:t,config:a}=this;this.renderer.resize();const n=s.createCommandEncoder();this.device.queue.writeBuffer(t.indirectDraw,0,this.indirectArgs);const i=this.context.canvas.width/this.context.canvas.height,r=ne(Math.PI/3,i,.1,100),h=se(r,e);this.cullParamsData.set(h),this.cullParamsData[16]=a.particleRadius,new Uint32Array(this.cullParamsData.buffer)[17]=t.particleCount,this.device.queue.writeBuffer(this.cullUniformBuffer,0,this.cullParamsData),this.renderer.render(n,this.context.getCurrentTexture().createView(),this.config,this.buffers,e,this.smoothBoundsSize),this.device.queue.submit([n.finish()])}}export{Te as F};
