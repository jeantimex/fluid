import{p as z,k as G,w as F,f as C,o as R,g as V,j as A,e as S,m as O,q as M,F as _,S as L,P as N,l as E,n as P}from"./picking_system-B3C-PV4U.js";import{e as k}from"./environment-ODazOT3W.js";const I=`/**
 * ============================================================================
...
`;class W{device;foamClearCounter;foamSpawn;foamUpdate;foamClearCounterBindGroup;foamSpawnBindGroup;foamUpdateBindGroup;constructor(e,t=!1){this.device=e;const n=t?q:I;t&&console.log("FoamPipeline: Using subgroup-optimized foam spawn shader"),this.foamClearCounter=this.createPipeline(j,"main"),this.foamSpawn=this.createPipeline(n,"main"),this.foamUpdate=this.createPipeline(H,"main")}createPipeline(e,t){return this.device.createComputePipeline({layout:"auto",compute:{module:this.device.createShaderModule({code:e}),entryPoint:t}})}createBindGroups(e,t){if(!e.foamPositions||!e.foamVelocities||!e.foamCounter)throw new Error("FoamPipeline requires FluidBuffers created with includeFoam.");this.foamClearCounterBindGroup=this.device.createBindGroup({layout:this.foamClearCounter.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:e.foamCounter}}]}),this.foamSpawnBindGroup=this.device.createBindGroup({layout:this.foamSpawn.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:e.predicted}},{binding:1,resource:{buffer:e.velocities}},{binding:3,resource:{buffer:e.foamPositions}},{binding:4,resource:{buffer:e.foamVelocities}},{binding:5,resource:{buffer:e.foamCounter}},{binding:6,resource:{buffer:t.spawn}},{binding:7,resource:{buffer:e.sortOffsets}}]}),this.foamUpdateBindGroup=this.device.createBindGroup({layout:this.foamUpdate.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:e.foamPositions}},{binding:1,resource:{buffer:e.foamVelocities}},{binding:2,resource:{buffer:t.update}},{binding:3,resource:{buffer:e.predicted}},{binding:4,resource:{buffer:e.velocities}},{binding:5,resource:{buffer:e.sortOffsets}}]})}dispatch(e,t,n,i=!1){if(i){const u=e.beginComputePass();u.setPipeline(this.foamClearCounter),u.setBindGroup(0,this.foamClearCounterBindGroup),u.dispatchWorkgroups(1),u.end()}const a=e.beginComputePass();a.setPipeline(this.foamSpawn),a.setBindGroup(0,this.foamSpawnBindGroup),a.dispatchWorkgroups(Math.ceil(t/256)),a.end();const r=e.beginComputePass();r.setPipeline(this.foamUpdate),r.setBindGroup(0,this.foamUpdateBindGroup),r.dispatchWorkgroups(Math.ceil(n/256)),r.end()}}const Y=`/**
...
`;class Q{device;pipeline;uniformBuffer;bindGroupLayout;bindGroup=null;constructor(e){this.device=e,this.uniformBuffer=e.createBuffer({size:80,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.bindGroupLayout=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]});const t=e.createShaderModule({code:J});this.pipeline=e.createRenderPipeline({layout:e.createPipelineLayout({bindGroupLayouts:[this.bindGroupLayout]}),vertex:{module:t,entryPoint:"vs_main"},fragment:{module:t,entryPoint:"fs_main",targets:[{format:"r16float",blend:{color:{srcFactor:"one",dstFactor:"one"},alpha:{srcFactor:"one",dstFactor:"one"}}}]},primitive:{topology:"triangle-list",cullMode:"none"},depthStencil:{format:"depth24plus",depthWriteEnabled:!1,depthCompare:"less-equal"}})}resize(e,t){}createBindGroup(e){this.bindGroup=this.device.createBindGroup({layout:this.bindGroupLayout,entries:[{binding:0,resource:{buffer:e.buffers.positions}},{binding:1,resource:{buffer:this.uniformBuffer}}]})}encode(e,t,n){if(!t.thicknessTexture||!t.depthTexture||!this.bindGroup)return;const i=new Float32Array(20);i.set(n.viewProjection),i[16]=n.canvasWidth,i[17]=n.canvasHeight,i[18]=n.particleRadius,i[19]=0,this.device.queue.writeBuffer(this.uniformBuffer,0,i);const a=e.beginRenderPass({colorAttachments:[{view:t.thicknessTexture.createView(),clearValue:{r:0,g:0,b:0,a:0},loadOp:"clear",storeOp:"store"}],depthStencilAttachment:{view:t.depthTexture.createView(),depthLoadOp:"load",depthStoreOp:"store"}});a.setPipeline(this.pipeline),a.setBindGroup(0,this.bindGroup),a.draw(6,t.buffers.particleCount),a.end()}}const $=`/**
 * Normal Pass Shader
 *
...
`;class ne{device;pipeline;bindGroupLayout;bindGroup=null;lastSource=null;lastDepth=null;sampler;constructor(e){this.device=e,this.sampler=e.createSampler({magFilter:"linear",minFilter:"linear"}),this.bindGroupLayout=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,sampler:{}}]});const t=e.createShaderModule({code:te});this.pipeline=e.createRenderPipeline({layout:e.createPipelineLayout({bindGroupLayouts:[this.bindGroupLayout]}),vertex:{module:t,entryPoint:"vs_main"},fragment:{module:t,entryPoint:"fs_main",targets:[{format:"r16float"}]},primitive:{topology:"triangle-list"}})}resize(e,t){}createBindGroup(e,t){this.bindGroup=this.device.createBindGroup({layout:this.bindGroupLayout,entries:[{binding:0,resource:e.createView()},{binding:1,resource:t.createView()},{binding:2,resource:this.sampler}]}),this.lastSource=e,this.lastDepth=t}encode(e,t,n,i,a,r){if((!this.bindGroup||this.lastSource!==i||this.lastDepth!==r)&&this.createBindGroup(i,r),!this.bindGroup)return;const u=e.beginRenderPass({colorAttachments:[{view:a.createView(),clearValue:{r:0,g:0,b:0,a:0},loadOp:"clear",storeOp:"store"}]});u.setPipeline(this.pipeline),u.setBindGroup(0,this.bindGroup),u.draw(6,1),u.end()}}const ie=`/**
...
`;class ae{device;compositePipeline;wireframePipeline;compositeBindGroupLayout;compositeBindGroup=null;wireframeBindGroup;sampler;uniformBuffer;envUniformBuffer;wireframeUniformBuffer;wireframeVertexBuffer;wireframeVertexData;constructor(e,t){this.device=e,this.sampler=e.createSampler({magFilter:"linear",minFilter:"linear"}),this.uniformBuffer=e.createBuffer({size:224,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.envUniformBuffer=e.createBuffer({size:240,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.compositeBindGroupLayout=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}},{binding:4,visibility:GPUShaderStage.FRAGMENT,sampler:{}},{binding:5,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:6,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:7,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float"}}]});const n=z(ie,{"../../../common/shaders/environment.wgsl":k,"../../../common/shaders/shadow_common.wgsl":G}),i=e.createShaderModule({code:n});this.compositePipeline=e.createRenderPipeline({layout:e.createPipelineLayout({bindGroupLayouts:[this.compositeBindGroupLayout]}),vertex:{module:i,entryPoint:"vs_main"},fragment:{module:i,entryPoint:"fs_main",targets:[{format:t}]},primitive:{topology:"triangle-list"}});const a=e.createShaderModule({code:F});this.wireframePipeline=e.createRenderPipeline({layout:"auto",vertex:{module:a,entryPoint:"vs_main",buffers:[{arrayStride:28,attributes:[{shaderLocation:0,offset:0,format:"float32x3"},{shaderLocation:1,offset:12,format:"float32x4"}]}]},fragment:{module:a,entryPoint:"fs_main",targets:[{format:t}]},primitive:{topology:"line-list"},depthStencil:{format:"depth24plus",depthWriteEnabled:!0,depthCompare:"less"}}),this.wireframeUniformBuffer=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.wireframeVertexData=new Float32Array(168),this.wireframeVertexBuffer=e.createBuffer({size:this.wireframeVertexData.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),this.wireframeBindGroup=e.createBindGroup({layout:this.wireframePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.wireframeUniformBuffer}}]})}resize(e,t){this.compositeBindGroup=null}buildBoundsWireframe(e){const t=e.boundsSize.x*.5,n=e.boundsSize.y*.5,i=e.boundsSize.z*.5,a=n-5,r=e.boundsWireframeColor??{r:1,g:1,b:1},u=[[-t,a-n,-i],[+t,a-n,-i],[+t,a+n,-i],[-t,a+n,-i],[-t,a-n,+i],[+t,a-n,+i],[+t,a+n,+i],[-t,a+n,+i]],l=[[0,1],[1,5],[5,4],[4,0],[3,2],[2,6],[6,7],[7,3],[0,3],[1,2],[5,6],[4,7]];let o=0;const h=d=>{const c=u[d];this.wireframeVertexData[o++]=c[0],this.wireframeVertexData[o++]=c[1],this.wireframeVertexData[o++]=c[2],this.wireframeVertexData[o++]=r.r,this.wireframeVertexData[o++]=r.g,this.wireframeVertexData[o++]=r.b,this.wireframeVertexData[o++]=1};for(const[d,c]of l)h(d),h(c);return l.length*2}createCompositeBindGroup(e){if(!e.smoothTextureB||!e.normalTexture||!e.smoothTextureA||!e.foamTexture||!e.shadowSmoothTexture){this.compositeBindGroup=null;return}this.compositeBindGroup=this.device.createBindGroup({layout:this.compositeBindGroupLayout,entries:[{binding:0,resource:e.smoothTextureB.createView()},{binding:1,resource:e.normalTexture.createView()},{binding:2,resource:e.smoothTextureA.createView()},{binding:3,resource:e.foamTexture.createView()},{binding:4,resource:this.sampler},{binding:5,resource:{buffer:this.uniformBuffer}},{binding:6,resource:{buffer:this.envUniformBuffer}},{binding:7,resource:e.shadowTexture.createView()}]})}encode(e,t,n,i){if(this.compositeBindGroup||this.createCompositeBindGroup(t),!this.compositeBindGroup)return;const a=new Float32Array(56);a.set(n.inverseViewProjection,0),a[16]=n.waterColor.r,a[17]=n.waterColor.g,a[18]=n.waterColor.b,a[19]=0,a[20]=n.deepWaterColor.r,a[21]=n.deepWaterColor.g,a[22]=n.deepWaterColor.b,a[23]=0,a[24]=n.foamColor.r,a[25]=n.foamColor.g,a[26]=n.foamColor.b,a[27]=n.foamOpacity,a[28]=n.extinctionCoeff.x,a[29]=n.extinctionCoeff.y,a[30]=n.extinctionCoeff.z,a[31]=n.extinctionMultiplier,a[32]=n.refractionStrength,a[33]=n.showFluidShadows?1:0,a[34]=0,a[35]=0,n.shadowViewProjection&&(a.set(n.shadowViewProjection,36),a[52]=n.shadowSoftness,a[53]=0,a[54]=0,a[55]=0),this.device.queue.writeBuffer(this.uniformBuffer,0,a);const r=new Float32Array(60);C(r,0,n,{...n,obstacleCentre:n.obstacleCentre,obstacleSize:{x:n.obstacleHalfSize.x*2,y:n.obstacleHalfSize.y*2,z:n.obstacleHalfSize.z*2}}),this.device.queue.writeBuffer(this.envUniformBuffer,0,r);const u=e.beginRenderPass({colorAttachments:[{view:i,clearValue:{r:0,g:0,b:0,a:1},loadOp:"clear",storeOp:"store"}]});if(u.setPipeline(this.compositePipeline),u.setBindGroup(0,this.compositeBindGroup),u.draw(6,1),u.end(),n.showBoundsWireframe&&t.depthTexture){const l=this.buildBoundsWireframe(n);this.device.queue.writeBuffer(this.wireframeVertexBuffer,0,this.wireframeVertexData.buffer,this.wireframeVertexData.byteOffset,l*7*4),this.device.queue.writeBuffer(this.wireframeUniformBuffer,0,n.viewProjection.buffer,n.viewProjection.byteOffset,n.viewProjection.byteLength);const o=e.beginRenderPass({colorAttachments:[{view:i,loadOp:"load",storeOp:"store"}],depthStencilAttachment:{view:t.depthTexture.createView(),depthLoadOp:"load",depthStoreOp:"store"}});o.setPipeline(this.wireframePipeline),o.setBindGroup(0,this.wireframeBindGroup),o.setVertexBuffer(0,this.wireframeVertexBuffer,0),o.draw(l),o.end()}}}const se=`// Debug shader - renders all particles as white dots to verify shadow pass works
...
`;class re{device;pipeline;uniformBuffer;bindGroupLayout;bindGroup=null;constructor(e){this.device=e,this.uniformBuffer=e.createBuffer({size:80,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.bindGroupLayout=e.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]});const t=e.createShaderModule({code:se});this.pipeline=e.createRenderPipeline({layout:e.createPipelineLayout({bindGroupLayouts:[this.bindGroupLayout]}),vertex:{module:t,entryPoint:"vs_main"},fragment:{module:t,entryPoint:"fs_main",targets:[{format:"r16float",blend:{color:{srcFactor:"one",dstFactor:"one"},alpha:{srcFactor:"one",dstFactor:"one"}}}]},primitive:{topology:"triangle-list",cullMode:"none"}})}createBindGroup(e){this.bindGroup=this.device.createBindGroup({layout:this.bindGroupLayout,entries:[{binding:0,resource:{buffer:e.positions}},{binding:1,resource:{buffer:this.uniformBuffer}}]})}buildShadowVP(e){const t=R(e.dirToSun),n={x:0,y:-2.5,z:0},i=30,a={x:n.x+t.x*i,y:n.y+t.y*i,z:n.z+t.z*i},r=Math.abs(t.y)>.99?{x:1,y:0,z:0}:{x:0,y:1,z:0},u=V(a,n,r),l=e.boundsSize.x*.5+2,o=e.boundsSize.y*.5+2,h=e.boundsSize.z*.5+2,d=Math.max(l,o,h),c=A(-d,d,-d,d,i-d-10,i+d+10);return S(c,u)}encode(e,t,n){if(!t.shadowTexture||!this.bindGroup)return null;const i=this.buildShadowVP(n),a=t.shadowTexture.width,r=t.shadowTexture.height,u=Math.max(a,r)*.05,l=new Float32Array(20);l.set(i),l[16]=a,l[17]=r,l[18]=u,l[19]=0,this.device.queue.writeBuffer(this.uniformBuffer,0,l);const o=e.beginRenderPass({colorAttachments:[{view:t.shadowTexture.createView(),clearValue:{r:0,g:0,b:0,a:0},loadOp:"clear",storeOp:"store"}]});return o.setPipeline(this.pipeline),o.setBindGroup(0,this.bindGroup),o.draw(6,t.buffers.particleCount),o.end(),i}}class oe{device;canvas;config;width=0;height=0;depthTexture=null;thicknessTexture=null;normalTexture=null;smoothTextureA=null;smoothTextureB=null;foamTexture=null;shadowTexture=null;shadowSmoothTexture=null;buffers=null;depthPass;thicknessPass;normalPass;smoothPass;foamPass;compositePass;shadowPass;constructor(e,t,n,i){this.device=e,this.canvas=t,this.config=i,this.depthPass=new X(e),this.thicknessPass=new Q(e),this.normalPass=new ee(e),this.smoothPass=new ne(e),this.foamPass=new K(e),this.compositePass=new ae(e,n),this.shadowPass=new re(e)}createBindGroups(e){this.buffers=e;const t={buffers:e,depthTexture:this.depthTexture,thicknessTexture:this.thicknessTexture,normalTexture:this.normalTexture,smoothTextureA:this.smoothTextureA,smoothTextureB:this.smoothTextureB,foamTexture:this.foamTexture,shadowTexture:this.shadowTexture,shadowSmoothTexture:this.shadowSmoothTexture};this.depthPass.createBindGroup(t),this.thicknessPass.createBindGroup(t),this.normalPass.createBindGroup(t),this.shadowPass.createBindGroup(e),e.foamPositions&&e.foamVelocities&&e.maxFoamParticles>0&&this.foamPass.createBindGroup(e.foamPositions,e.foamVelocities,e.maxFoamParticles)}resize(e,t){if(e===this.width&&t===this.height)return;this.width=Math.max(1,Math.floor(e)),this.height=Math.max(1,Math.floor(t)),this.depthTexture=this.device.createTexture({size:{width:this.width,height:this.height},format:"depth24plus",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING});const n=GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING;this.thicknessTexture=this.device.createTexture({size:{width:this.width,height:this.height},format:"r16float",usage:n}),this.normalTexture=this.device.createTexture({size:{width:this.width,height:this.height},format:"rgba16float",usage:n}),this.smoothTextureA=this.device.createTexture({size:{width:this.width,height:this.height},format:"r16float",usage:n}),this.smoothTextureB=this.device.createTexture({size:{width:this.width,height:this.height},format:"r16float",usage:n}),this.foamTexture=this.device.createTexture({size:{width:this.width,height:this.height},format:"r16float",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING});const i=Math.max(1,Math.floor(this.width/4)),a=Math.max(1,Math.floor(this.height/4));this.shadowTexture=this.device.createTexture({size:{width:i,height:a},format:"r16float",usage:n}),this.shadowSmoothTexture=this.device.createTexture({size:{width:i,height:a},format:"r16float",usage:n}),this.depthPass.resize(this.width,this.height),this.thicknessPass.resize(this.width,this.height),this.normalPass.resize(this.width,this.height),this.smoothPass.resize(this.width,this.height),this.compositePass.resize(this.width,this.height)}render(e,t,n){if(!this.buffers)return;const i=this.canvas.width/this.canvas.height,a=.1,r=100,u=O(Math.PI/3,i,a,r),l=S(u,n),o=M(l),h=window.devicePixelRatio||1,d=this.config.showObstacle!==!1,c=this.config.obstacleShape??"box",g=c==="sphere",m=this.config.obstacleRadius??0,f={...this.config,viewProjection:l,inverseViewProjection:o,canvasWidth:this.canvas.width,canvasHeight:this.canvas.height,particleRadius:this.config.particleRadius*h,foamParticleRadius:this.config.foamParticleRadius*h,near:a,far:r,obstacleHalfSize:{x:d?g?m:this.config.obstacleSize.x*.5:0,y:d?g?m:this.config.obstacleSize.y*.5:0,z:d?g?m:this.config.obstacleSize.z*.5:0},obstacleColor:this.config.obstacleColor??{r:1,g:0,b:0},obstacleAlpha:d?this.config.obstacleAlpha??.8:0,obstacleShape:c,obstacleRadius:m,showBoundsWireframe:this.config.showBoundsWireframe,boundsWireframeColor:this.config.boundsWireframeColor,boundsSize:this.config.boundsSize,shadowViewProjection:null,shadowSoftness:this.config.shadowSoftness},s={buffers:this.buffers,depthTexture:this.depthTexture,thicknessTexture:this.thicknessTexture,normalTexture:this.normalTexture,smoothTextureA:this.smoothTextureA,smoothTextureB:this.smoothTextureB,foamTexture:this.foamTexture,shadowTexture:this.shadowTexture,shadowSmoothTexture:this.shadowSmoothTexture};if(this.depthPass.encode(e,s,f),this.thicknessPass.encode(e,s,f),s.foamTexture&&this.foamPass.encode(e,s,f,s.foamTexture),this.config.showFluidShadows){const v=this.shadowPass.encode(e,s,f);f.shadowViewProjection=v,s.shadowTexture&&s.shadowSmoothTexture&&this.smoothPass.encode(e,s,f,s.shadowTexture,s.shadowSmoothTexture,s.shadowTexture)}s.thicknessTexture&&s.smoothTextureA&&s.smoothTextureB&&(this.smoothPass.encode(e,s,f,s.thicknessTexture,s.smoothTextureB,s.smoothTextureA),this.smoothPass.encode(e,s,f,s.smoothTextureB,s.thicknessTexture,s.smoothTextureA),this.smoothPass.encode(e,s,f,s.thicknessTexture,s.smoothTextureB,s.smoothTextureA),this.smoothPass.encode(e,s,f,s.smoothTextureB,s.thicknessTexture,s.smoothTextureA),this.smoothPass.encode(e,s,f,s.thicknessTexture,s.smoothTextureB,s.smoothTextureA)),this.normalPass.encode(e,s,f),this.compositePass.encode(e,s,f,t)}}class de{device;context;canvas;config;buffers;physics;grid;foam;renderer;pickingSystem;state;gridRes={x:0,y:0,z:0};gridTotalCells=0;isPicking=!1;interactionPos={x:0,y:0,z:0};physicsUniforms;gridUniforms;foamUniforms;computeData=new Float32Array(8);integrateData=new Float32Array(24);hashParamsData=new Float32Array(8);sortParamsData=new Uint32Array(8);scanParamsDataL0=new Uint32Array(4);scanParamsDataL1=new Uint32Array(4);scanParamsDataL2=new Uint32Array(4);densityParamsData=new Float32Array(12);pressureParamsData=new Float32Array(16);viscosityParamsData=new Float32Array(12);foamSpawnData=new Float32Array(28);foamUpdateData=new Float32Array(28);foamFrameCount=0;simTimer=0;constructor(e,t,n,i,a,r=!1,u=!1){this.device=e,this.context=t,this.canvas=n,this.config=i,this.physics=new _(e,u),this.grid=new L(e,r),this.foam=new W(e,r),this.renderer=new oe(e,n,a,i),this.pickingSystem=new N(e),this.physicsUniforms={external:e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),density:e.createBuffer({size:48,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),pressure:e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),viscosity:e.createBuffer({size:48,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),integrate:e.createBuffer({size:96,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})},this.gridUniforms={hash:e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),sort:e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),scanL0:e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),scanL1:e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),scanL2:e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})},this.foamUniforms={spawn:e.createBuffer({size:112,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),update:e.createBuffer({size:112,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})},this.reset()}get particleCount(){return this.buffers.particleCount}get simulationState(){return this.state}reset(){this.buffers&&this.buffers.destroy(),this.simTimer=0,this.foamFrameCount=0;const{boundsSize:e,smoothingRadius:t}=this.config;this.gridRes={x:Math.ceil(e.x/t),y:Math.ceil(e.y/t),z:Math.ceil(e.z/t)},this.gridTotalCells=this.gridRes.x*this.gridRes.y*this.gridRes.z;const n=E(this.config);this.state=this.createStateFromSpawn(n),this.buffers=new P(this.device,n,{gridTotalCells:this.gridTotalCells,includeFoam:!0,maxFoamParticles:P.DEFAULT_MAX_FOAM_PARTICLES}),this.physics.createBindGroups(this.buffers,this.physicsUniforms),this.grid.createBindGroups(this.buffers,this.gridUniforms),this.foam.createBindGroups(this.buffers,this.foamUniforms),this.renderer.createBindGroups(this.buffers),this.pickingSystem.createBindGroup(this.buffers.positions)}createStateFromSpawn(e){return{positions:e.positions,predicted:new Float32Array(e.positions),velocities:e.velocities,densities:new Float32Array(e.count*2),keys:new Uint32Array(e.count),sortedKeys:new Uint32Array(e.count),indices:new Uint32Array(e.count),sortOffsets:new Uint32Array(e.count),spatialOffsets:new Uint32Array(e.count),positionsSorted:new Float32Array(e.count*4),predictedSorted:new Float32Array(e.count*4),velocitiesSorted:new Float32Array(e.count*4),count:e.count,input:{worldX:0,worldY:0,worldZ:0,pull:!1,push:!1}}}async step(e){const{config:t,buffers:n,device:i}=this,a=t.maxTimestepFPS?1/t.maxTimestepFPS:Number.POSITIVE_INFINITY,r=Math.min(e*t.timeScale,a);this.simTimer+=r;const u=r/t.iterationsPerFrame;this.updateUniforms(u);const l=i.createCommandEncoder();let o=!1;!this.isPicking&&this.state.input.rayOrigin&&this.state.input.rayDir&&(this.isPicking=!0,o=!0,this.pickingSystem.dispatch(l,this.state.input.rayOrigin,this.state.input.rayDir,t.smoothingRadius,n.particleCount));const h=l.beginComputePass();for(let c=0;c<t.iterationsPerFrame;c++)this.physics.step(h,this.grid,n.particleCount,this.gridTotalCells,t.viscosityStrength>0);h.end(),this.dispatchFoam(r,l),i.queue.submit([l.finish()]),o&&this.pickingSystem.getResult().then(c=>{if(c&&c.hit){let g=c.hitPos.x,m=c.hitPos.y,f=c.hitPos.z;this.state.input.pull&&this.state.input.rayDir&&(g+=this.state.input.rayDir.x*.5,m+=this.state.input.rayDir.y*.5,f+=this.state.input.rayDir.z*.5),this.state.input.worldX=g,this.state.input.worldY=m,this.state.input.worldZ=f,this.state.input.isHoveringFluid=!0}else this.state.input.isHoveringFluid=!1;this.isPicking=!1});const d=.15;this.interactionPos.x+=(this.state.input.worldX-this.interactionPos.x)*d,this.interactionPos.y+=(this.state.input.worldY-this.interactionPos.y)*d,this.interactionPos.z+=(this.state.input.worldZ-this.interactionPos.z)*d}updateUniforms(e){const{config:t,state:n,buffers:i,device:a}=this;let r=0;n.input.push?r=-t.interactionStrength:n.input.pull&&(r=t.interactionStrength),this.computeData[0]=e,this.computeData[1]=t.gravity,this.computeData[2]=t.interactionRadius,this.computeData[3]=r,this.computeData[4]=this.interactionPos.x,this.computeData[5]=this.interactionPos.y,this.computeData[6]=this.interactionPos.z,this.computeData[7]=0,a.queue.writeBuffer(this.physicsUniforms.external,0,this.computeData),this.hashParamsData[0]=t.smoothingRadius,this.hashParamsData[1]=i.particleCount,this.hashParamsData[2]=-t.boundsSize.x*.5,this.hashParamsData[3]=-5,this.hashParamsData[4]=-t.boundsSize.z*.5,this.hashParamsData[5]=this.gridRes.x,this.hashParamsData[6]=this.gridRes.y,this.hashParamsData[7]=this.gridRes.z,a.queue.writeBuffer(this.gridUniforms.hash,0,this.hashParamsData),this.sortParamsData[0]=i.particleCount,this.sortParamsData[1]=this.gridTotalCells,a.queue.writeBuffer(this.gridUniforms.sort,0,this.sortParamsData);const u=Math.ceil((this.gridTotalCells+1)/512),l=Math.ceil(u/512);this.scanParamsDataL0[0]=this.gridTotalCells+1,this.scanParamsDataL1[0]=u,this.scanParamsDataL2[0]=l,a.queue.writeBuffer(this.gridUniforms.scanL0,0,this.scanParamsDataL0),a.queue.writeBuffer(this.gridUniforms.scanL1,0,this.scanParamsDataL1),a.queue.writeBuffer(this.gridUniforms.scanL2,0,this.scanParamsDataL2);const o=t.smoothingRadius,h=15/(2*Math.PI*Math.pow(o,5)),d=15/(Math.PI*Math.pow(o,6));this.densityParamsData[0]=o,this.densityParamsData[1]=h,this.densityParamsData[2]=d,this.densityParamsData[3]=i.particleCount,this.densityParamsData[4]=-t.boundsSize.x*.5,this.densityParamsData[5]=-5,this.densityParamsData[6]=-t.boundsSize.z*.5,this.densityParamsData[7]=0,this.densityParamsData[8]=this.gridRes.x,this.densityParamsData[9]=this.gridRes.y,this.densityParamsData[10]=this.gridRes.z,this.densityParamsData[11]=0,a.queue.writeBuffer(this.physicsUniforms.density,0,this.densityParamsData);const c=15/(Math.PI*Math.pow(o,5)),g=45/(Math.PI*Math.pow(o,6));this.pressureParamsData[0]=e,this.pressureParamsData[1]=t.targetDensity,this.pressureParamsData[2]=t.pressureMultiplier,this.pressureParamsData[3]=t.nearPressureMultiplier,this.pressureParamsData[4]=o,this.pressureParamsData[5]=c,this.pressureParamsData[6]=g,this.pressureParamsData[7]=i.particleCount,this.pressureParamsData[8]=-t.boundsSize.x*.5,this.pressureParamsData[9]=-5,this.pressureParamsData[10]=-t.boundsSize.z*.5,this.pressureParamsData[11]=0,this.pressureParamsData[12]=this.gridRes.x,this.pressureParamsData[13]=this.gridRes.y,this.pressureParamsData[14]=this.gridRes.z,this.pressureParamsData[15]=0,a.queue.writeBuffer(this.physicsUniforms.pressure,0,this.pressureParamsData);const m=315/(64*Math.PI*Math.pow(o,9));this.viscosityParamsData[0]=e,this.viscosityParamsData[1]=t.viscosityStrength,this.viscosityParamsData[2]=o,this.viscosityParamsData[3]=m,this.viscosityParamsData[4]=i.particleCount,this.viscosityParamsData[5]=-t.boundsSize.x*.5,this.viscosityParamsData[6]=-5,this.viscosityParamsData[7]=-t.boundsSize.z*.5,this.viscosityParamsData[8]=this.gridRes.x,this.viscosityParamsData[9]=this.gridRes.y,this.viscosityParamsData[10]=this.gridRes.z,this.viscosityParamsData[11]=0,a.queue.writeBuffer(this.physicsUniforms.viscosity,0,this.viscosityParamsData),this.integrateData[0]=e,this.integrateData[1]=t.collisionDamping;const s=(t.obstacleShape??"box")==="sphere",v=t.obstacleRadius??0,U=t.showObstacle!==!1&&(s?v>0:t.obstacleSize.x>0&&t.obstacleSize.y>0&&t.obstacleSize.z>0);this.integrateData[2]=U?1:0,this.integrateData[3]=s?1:0;const b=t.boundsSize,x=b.x*.5,y=b.z*.5,w=-5;this.integrateData[4]=-x,this.integrateData[5]=w,this.integrateData[6]=-y,this.integrateData[8]=x,this.integrateData[9]=w+b.y,this.integrateData[10]=y,this.integrateData[12]=t.obstacleCentre.x,this.integrateData[13]=s?t.obstacleCentre.y:t.obstacleCentre.y+t.obstacleSize.y*.5,this.integrateData[14]=t.obstacleCentre.z;const B=s?v:t.obstacleSize.x*.5,T=s?v:t.obstacleSize.y*.5,D=s?v:t.obstacleSize.z*.5;this.integrateData[16]=B,this.integrateData[17]=T,this.integrateData[18]=D,this.integrateData[20]=t.obstacleRotation.x,this.integrateData[21]=t.obstacleRotation.y,this.integrateData[22]=t.obstacleRotation.z,a.queue.writeBuffer(this.physicsUniforms.integrate,0,this.integrateData)}dispatchFoam(e,t){const{buffers:n,config:i,device:a}=this,r=n.maxFoamParticles;this.foamFrameCount++;const u=i.spawnRateFadeInTime<=0?1:Math.min(1,Math.max(0,(this.simTimer-i.spawnRateFadeStartTime)/i.spawnRateFadeInTime));this.foamSpawnData[0]=e,this.foamSpawnData[1]=i.foamSpawnRate*u*u,this.foamSpawnData[2]=i.trappedAirVelocityMin,this.foamSpawnData[3]=i.trappedAirVelocityMax,this.foamSpawnData[4]=i.foamKineticEnergyMin,this.foamSpawnData[5]=i.foamKineticEnergyMax;const l=new Uint32Array(this.foamSpawnData.buffer);l[6]=r,l[7]=this.foamFrameCount,this.foamSpawnData[8]=n.particleCount,this.foamSpawnData[9]=i.smoothingRadius,this.foamSpawnData[10]=i.foamLifetimeMin,this.foamSpawnData[11]=i.foamLifetimeMax,this.foamSpawnData[12]=-i.boundsSize.x*.5,this.foamSpawnData[13]=-5,this.foamSpawnData[14]=-i.boundsSize.z*.5,this.foamSpawnData[16]=this.gridRes.x,this.foamSpawnData[17]=this.gridRes.y,this.foamSpawnData[18]=this.gridRes.z,this.foamSpawnData[19]=i.bubbleScale,a.queue.writeBuffer(this.foamUniforms.spawn,0,this.foamSpawnData),this.foamUpdateData[0]=e,this.foamUpdateData[1]=i.gravity,this.foamUpdateData[2]=.04,this.foamUpdateData[3]=i.bubbleBuoyancy;const o=i.boundsSize.x*.5,h=i.boundsSize.z*.5,d=-5;this.foamUpdateData[4]=o,this.foamUpdateData[5]=d+i.boundsSize.y,this.foamUpdateData[6]=h,this.foamUpdateData[7]=i.smoothingRadius,this.foamUpdateData[8]=-o,this.foamUpdateData[9]=d,this.foamUpdateData[10]=-h,this.foamUpdateData[11]=0,this.foamUpdateData[12]=this.gridRes.x,this.foamUpdateData[13]=this.gridRes.y,this.foamUpdateData[14]=this.gridRes.z,this.foamUpdateData[15]=0;const c=new Uint32Array(this.foamUpdateData.buffer);c[16]=i.bubbleClassifyMinNeighbours,c[17]=i.sprayClassifyMaxNeighbours,this.foamUpdateData[18]=i.bubbleScale,this.foamUpdateData[19]=i.bubbleChangeScaleSpeed,a.queue.writeBuffer(this.foamUniforms.update,0,this.foamUpdateData),this.foam.dispatch(t,n.particleCount,r,!1)}render(e){this.renderer.resize(this.canvas.width,this.canvas.height);const t=this.device.createCommandEncoder();this.renderer.render(t,this.context.getCurrentTexture().createView(),e),this.device.queue.submit([t.finish()])}}export{de as F};
