import{p as K,w as ae,m as se,e as ee,f as re,g as oe,j as le,k as Q,F as ce,S as ue,P as de,l as he,n as fe}from"./picking_system-CJTWpPbq.js";import{e as pe}from"./environment-ODazOT3W.js";import{s as me,a as Pe,b as ge}from"./splat_resolve-CMJnQc1h.js";const ye=`/**
 * ============================================================================
...
`;function Se(H,e){const n=[...H].sort((a,s)=>a.t-s.t),t=new Array(e);for(let a=0;a<e;a+=1){const s=e===1?0:a/(e-1);let i=n[0],r=n[n.length-1];for(let u=0;u<n.length-1;u+=1){const b=n[u],P=n[u+1];if(s>=b.t&&s<=P.t){i=b,r=P;break}}const d=r.t-i.t||1,o=(s-i.t)/d,y=i.r+(r.r-i.r)*o,h=i.g+(r.g-i.g)*o,c=i.b+(r.b-i.b)*o;t[a]={r:y,g:h,b:c}}return t}class Be{device;particlePipeline;facePipeline;backgroundPipeline;shadowParticlePipeline;shadowObstaclePipeline;wireframePipeline;cullPipeline;uniformBuffer;gradientBuffer;envUniformBuffer;camUniformBuffer;shadowUniformBuffer;particleBindGroup;faceBindGroup;backgroundBindGroup;shadowParticleBindGroup;shadowObstacleBindGroup;wireframeBindGroup;cullBindGroup;lineVertexBuffer;lineVertexData;wireframeVertexBuffer;wireframeVertexData;wireframeUniformBuffer;canvas;depthTexture;depthWidth=0;depthHeight=0;shadowTexture;shadowMapSize=2048;shadowSampler;densitySampler;densityUniformBuffer;lastObstacleParams="";lastWireframeParams="";lastEnvParams="";lastFaceCount=0;lastWireframeVertexCount=0;constructor(e,n,t,a){this.device=e,this.canvas=n,this.uniformBuffer=e.createBuffer({size:112,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.envUniformBuffer=e.createBuffer({size:240,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.camUniformBuffer=e.createBuffer({size:80,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.densityUniformBuffer=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.shadowUniformBuffer=e.createBuffer({size:96,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});const s=Se(a.colorKeys,a.gradientResolution),i=new Float32Array(a.gradientResolution*4);for(let f=0;f<s.length;f++)i[f*4]=s[f].r,i[f*4+1]=s[f].g,i[f*4+2]=s[f].b,i[f*4+3]=1;this.gradientBuffer=e.createBuffer({size:i.byteLength,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST,mappedAtCreation:!0}),new Float32Array(this.gradientBuffer.getMappedRange()).set(i),this.gradientBuffer.unmap();const r=K(ye,{"../../common/shaders/shadow_common.wgsl":Q}),d=e.createShaderModule({code:r});this.particlePipeline=e.createRenderPipeline({layout:"auto",vertex:{module:d,entryPoint:"vs_main"},fragment:{module:d,entryPoint:"fs_main",targets:[{format:t}]},primitive:{topology:"triangle-list"},depthStencil:{format:"depth24plus",depthWriteEnabled:!0,depthCompare:"less"}});const o=K(we,{"../../common/shaders/shadow_common.wgsl":Q}),y=e.createShaderModule({code:o});this.facePipeline=e.createRenderPipeline({layout:"auto",vertex:{module:y,entryPoint:"vs_main",buffers:[{arrayStride:40,attributes:[{shaderLocation:0,offset:0,format:"float32x3"},{shaderLocation:1,offset:12,format:"float32x3"},{shaderLocation:2,offset:24,format:"float32x4"}]}]},fragment:{module:y,entryPoint:"fs_main",targets:[{format:t,blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one-minus-src-alpha",operation:"add"}}}]},primitive:{topology:"triangle-list",cullMode:"back"},depthStencil:{format:"depth24plus",depthWriteEnabled:!1,depthCompare:"less"}});const h=K(ve,{"../../common/shaders/environment.wgsl":pe,"../../common/shaders/shadow_common.wgsl":Q}),c=e.createShaderModule({code:h});this.backgroundPipeline=e.createRenderPipeline({layout:"auto",vertex:{module:c,entryPoint:"vs_main"},fragment:{module:c,entryPoint:"fs_main",targets:[{format:t}]},primitive:{topology:"triangle-list"},depthStencil:{format:"depth24plus",depthWriteEnabled:!1,depthCompare:"always"}});const u=K(xe,{"shadow_common.wgsl":Q}),b=e.createShaderModule({code:u});this.shadowParticlePipeline=e.createRenderPipeline({layout:"auto",vertex:{module:b,entryPoint:"vs_particles"},primitive:{topology:"triangle-list",cullMode:"none"},depthStencil:{format:"depth24plus",depthWriteEnabled:!0,depthCompare:"less"}}),this.shadowObstaclePipeline=e.createRenderPipeline({layout:"auto",vertex:{module:b,entryPoint:"vs_obstacle",buffers:[{arrayStride:40,attributes:[{shaderLocation:0,offset:0,format:"float32x3"}]}]},primitive:{topology:"triangle-list",cullMode:"back"},depthStencil:{format:"depth24plus",depthWriteEnabled:!0,depthCompare:"less"}});const P=e.createShaderModule({code:be});this.cullPipeline=e.createComputePipeline({layout:"auto",compute:{module:P,entryPoint:"main"}});const m=e.createShaderModule({code:ae});this.wireframePipeline=e.createRenderPipeline({layout:"auto",vertex:{module:m,entryPoint:"vs_main",buffers:[{arrayStride:28,attributes:[{shaderLocation:0,offset:0,format:"float32x3"},{shaderLocation:1,offset:12,format:"float32x4"}]}]},fragment:{module:m,entryPoint:"fs_main",targets:[{format:t}]},primitive:{topology:"line-list"},depthStencil:{format:"depth24plus",depthWriteEnabled:!0,depthCompare:"less"}}),this.wireframeUniformBuffer=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.wireframeVertexData=new Float32Array(168),this.wireframeVertexBuffer=e.createBuffer({size:this.wireframeVertexData.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});const x=384*6,z=Math.max(36,x)*10;this.lineVertexData=new Float32Array(z),this.lineVertexBuffer=e.createBuffer({size:this.lineVertexData.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST}),this.shadowTexture=this.device.createTexture({size:[this.shadowMapSize,this.shadowMapSize],format:"depth24plus",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),this.shadowSampler=this.device.createSampler({compare:"less",magFilter:"linear",minFilter:"linear"}),this.faceBindGroup=e.createBindGroup({layout:this.facePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.uniformBuffer}},{binding:1,resource:this.shadowTexture.createView()},{binding:2,resource:this.shadowSampler},{binding:3,resource:{buffer:this.shadowUniformBuffer}}]}),this.shadowObstacleBindGroup=e.createBindGroup({layout:this.shadowObstaclePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.shadowUniformBuffer}}]}),this.wireframeBindGroup=e.createBindGroup({layout:this.wireframePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.wireframeUniformBuffer}}]}),this.densitySampler=this.device.createSampler({addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",addressModeW:"clamp-to-edge",magFilter:"linear",minFilter:"linear"}),this.resize()}resize(){const e=this.canvas.width,n=this.canvas.height;this.depthTexture&&e===this.depthWidth&&n===this.depthHeight||(this.depthTexture&&this.depthTexture.destroy(),this.depthTexture=this.device.createTexture({size:[e,n],format:"depth24plus",usage:GPUTextureUsage.RENDER_ATTACHMENT}),this.depthWidth=e,this.depthHeight=n)}createBindGroup(e,n,t){this.particleBindGroup=this.device.createBindGroup({layout:this.particlePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:e.positions}},{binding:1,resource:{buffer:e.velocities}},{binding:2,resource:{buffer:this.uniformBuffer}},{binding:3,resource:{buffer:this.gradientBuffer}},{binding:4,resource:{buffer:e.visibleIndices}},{binding:5,resource:this.shadowTexture.createView()},{binding:6,resource:this.shadowSampler},{binding:7,resource:{buffer:this.shadowUniformBuffer}}]}),this.shadowParticleBindGroup=this.device.createBindGroup({layout:this.shadowParticlePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.shadowUniformBuffer}},{binding:1,resource:{buffer:e.positions}},{binding:2,resource:{buffer:e.visibleIndices}}]}),this.cullBindGroup=this.device.createBindGroup({layout:this.cullPipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:e.positions}},{binding:1,resource:{buffer:e.visibleIndices}},{binding:2,resource:{buffer:e.indirectDraw}},{binding:3,resource:{buffer:t}}]}),this.backgroundBindGroup=this.device.createBindGroup({layout:this.backgroundPipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.envUniformBuffer}},{binding:1,resource:{buffer:this.camUniformBuffer}},{binding:2,resource:n},{binding:3,resource:this.densitySampler},{binding:4,resource:{buffer:this.densityUniformBuffer}},{binding:5,resource:this.shadowTexture.createView()},{binding:6,resource:this.shadowSampler},{binding:7,resource:{buffer:this.shadowUniformBuffer}}]})}buildObstacleGeometry(e){const n=e.obstacleShape??"box",t=e.obstacleColor??{r:1,g:0,b:0},a=e.obstacleAlpha??.8;if(n==="sphere"){const p=e.obstacleRadius??0;if(p<=0)return{faceCount:0};const S=e.obstacleCentre.x,T=e.obstacleCentre.y,M=e.obstacleCentre.z;let g=0;const U=(A,E)=>{this.lineVertexData[g++]=A[0],this.lineVertexData[g++]=A[1],this.lineVertexData[g++]=A[2],this.lineVertexData[g++]=E[0],this.lineVertexData[g++]=E[1],this.lineVertexData[g++]=E[2],this.lineVertexData[g++]=t.r,this.lineVertexData[g++]=t.g,this.lineVertexData[g++]=t.b,this.lineVertexData[g++]=a},D=16,V=24;for(let A=0;A<D;A++){const E=A/D,te=(A+1)/D,F=E*Math.PI,C=te*Math.PI;for(let _=0;_<V;_++){const X=_/V,Y=(_+1)/V,N=X*Math.PI*2,L=Y*Math.PI*2,R=[Math.sin(F)*Math.cos(N),Math.cos(F),Math.sin(F)*Math.sin(N)],v=[Math.sin(F)*Math.cos(L),Math.cos(F),Math.sin(F)*Math.sin(L)],G=[Math.sin(C)*Math.cos(N),Math.cos(C),Math.sin(C)*Math.sin(N)],ne=[Math.sin(C)*Math.cos(L),Math.cos(C),Math.sin(C)*Math.sin(L)],$=Z=>{const ie=Z;U([Z[0]*p+S,Z[1]*p+T,Z[2]*p+M],ie)};$(R),$(ne),$(G),$(R),$(v),$(ne)}}return{faceCount:D*V*6}}const s=e.obstacleSize.x*.5,i=e.obstacleSize.y*.5,r=e.obstacleSize.z*.5;if(s<=0||i<=0||r<=0)return{faceCount:0};const d=e.obstacleCentre.x,o=e.obstacleCentre.y+e.obstacleSize.y*.5,y=e.obstacleCentre.z,h=Math.PI/180,c=e.obstacleRotation.x*h,u=e.obstacleRotation.y*h,b=e.obstacleRotation.z*h,P=Math.cos(c),m=Math.sin(c),x=Math.cos(u),z=Math.sin(u),f=Math.cos(b),I=Math.sin(b),B=(p,S,T)=>{const M=S*P-T*m,g=S*m+T*P,U=p*x+g*z,D=-p*z+g*x,V=U*f-M*I,W=U*I+M*f;return[V+d,W+o,D+y]},k=[B(-s,-i,-r),B(+s,-i,-r),B(+s,+i,-r),B(-s,+i,-r),B(-s,-i,+r),B(+s,-i,+r),B(+s,+i,+r),B(-s,+i,+r)],O=(p,S,T)=>{const M=S*P-T*m,g=S*m+T*P,U=p*x+g*z,D=-p*z+g*x,V=U*f-M*I,W=U*I+M*f;return[V,W,D]},j=[O(0,0,-1),O(0,0,1),O(-1,0,0),O(1,0,0),O(0,-1,0),O(0,1,0)];let l=0;const w=(p,S)=>{this.lineVertexData[l++]=p[0],this.lineVertexData[l++]=p[1],this.lineVertexData[l++]=p[2],this.lineVertexData[l++]=S[0],this.lineVertexData[l++]=S[1],this.lineVertexData[l++]=S[2],this.lineVertexData[l++]=t.r,this.lineVertexData[l++]=t.g,this.lineVertexData[l++]=t.b,this.lineVertexData[l++]=a},q=[[0,2,1,0,3,2],[4,5,6,4,6,7],[0,4,7,0,7,3],[1,2,6,1,6,5],[0,1,5,0,5,4],[3,7,6,3,6,2]];for(let p=0;p<q.length;p++){const S=j[p];for(const T of q[p])w(k[T],S)}return{faceCount:36}}buildBoundsWireframe(e){const n=e.boundsSize.x*.5,t=e.boundsSize.y*.5,a=e.boundsSize.z*.5,s=t-5,i=e.boundsWireframeColor??{r:1,g:1,b:1},r=[[-n,s-t,-a],[+n,s-t,-a],[+n,s+t,-a],[-n,s+t,-a],[-n,s-t,+a],[+n,s-t,+a],[+n,s+t,+a],[-n,s+t,+a]],d=[[0,1],[1,5],[5,4],[4,0],[3,2],[2,6],[6,7],[7,3],[0,3],[1,2],[5,6],[4,7]];let o=0;const y=h=>{const c=r[h];this.wireframeVertexData[o++]=c[0],this.wireframeVertexData[o++]=c[1],this.wireframeVertexData[o++]=c[2],this.wireframeVertexData[o++]=i.r,this.wireframeVertexData[o++]=i.g,this.wireframeVertexData[o++]=i.b,this.wireframeVertexData[o++]=1};for(const[h,c]of d)y(h),y(c);return d.length*2}render(e,n,t,a,s){const i=t.obstacleColor??{r:1,g:0,b:0},r=t.obstacleAlpha??.8,d=e.beginComputePass();d.setPipeline(this.cullPipeline),d.setBindGroup(0,this.cullBindGroup),d.dispatchWorkgroups(Math.ceil(a.particleCount/256)),d.end();const o=this.canvas.width/this.canvas.height,y=se(Math.PI/3,o,.1,100),h=ee(y,s),c=window.devicePixelRatio||1,u=new Float32Array(28);u.set(h),u[16]=this.canvas.width,u[17]=this.canvas.height,u[18]=t.particleRadius*c,u[19]=t.velocityDisplayMax,u[20]=t.sceneExposure,u[21]=t.floorAmbient,u[22]=t.sunBrightness,u[23]=0,u[24]=t.dirToSun.x,u[25]=t.dirToSun.y,u[26]=t.dirToSun.z,u[27]=0,this.device.queue.writeBuffer(this.uniformBuffer,0,u);const b=`${t.globalBrightness}-${t.globalSaturation}-${t.floorAmbient}-${t.sunBrightness}-${t.dirToSun.x}-${t.dirToSun.y}-${t.dirToSun.z}-${i.r}-${i.g}-${i.b}-${r}`;if(b!==this.lastEnvParams){const G=new Float32Array(60);re(G,0,t,t),this.device.queue.writeBuffer(this.envUniformBuffer,0,G),this.lastEnvParams=b}const P={x:s[0],y:s[4],z:s[8]},m={x:s[1],y:s[5],z:s[9]},x={x:s[2],y:s[6],z:s[10]},z={x:-x.x,y:-x.y,z:-x.z},f=s[12],I=s[13],B=s[14],k=-(P.x*f+m.x*I+x.x*B),O=-(P.y*f+m.y*I+x.y*B),j=-(P.z*f+m.z*I+x.z*B),l=new Float32Array(20);l[0]=k,l[1]=O,l[2]=j,l[3]=0,l[4]=z.x,l[5]=z.y,l[6]=z.z,l[7]=0,l[8]=P.x,l[9]=P.y,l[10]=P.z,l[11]=0,l[12]=m.x,l[13]=m.y,l[14]=m.z,l[15]=0,l[16]=Math.PI/3,l[17]=o,this.device.queue.writeBuffer(this.camUniformBuffer,0,l);const w=new Float32Array(16),q=t.boundsSize,J=q.x*.5,p=q.z*.5,S=-5;w[0]=-J,w[1]=S,w[2]=-p,w[3]=0,w[4]=J,w[5]=S+q.y,w[6]=p,w[7]=0,w[8]=t.densityOffset,w[9]=t.densityMultiplier,w[10]=t.lightStepSize,w[11]=t.shadowSoftness,w[12]=t.extinctionCoefficients.x,w[13]=t.extinctionCoefficients.y,w[14]=t.extinctionCoefficients.z,w[15]=0,this.device.queue.writeBuffer(this.densityUniformBuffer,0,w);const T=t.boundsSize,M=t.floorSize,g=t.dirToSun,U=Math.max(T.x+T.z,M.x+M.z),D=U*.6,V={x:g.x*U,y:g.y*U,z:g.z*U},W=oe(V,{x:0,y:0,z:0},{x:0,y:1,z:0}),A=le(-D,D,-D,D,.1,-U*3),E=ee(A,W),F=Math.max(.001,t.smoothingRadius)/D,C=new Float32Array(20);C.set(E),C[16]=t.shadowSoftness??1,C[17]=F,C[18]=0,C[19]=0,this.device.queue.writeBuffer(this.shadowUniformBuffer,0,C);const _=t.showObstacle!==!1,X=`${_}-${t.obstacleShape}-${t.obstacleSize.x}-${t.obstacleSize.y}-${t.obstacleSize.z}-${t.obstacleCentre.x}-${t.obstacleCentre.y}-${t.obstacleCentre.z}-${t.obstacleRotation.x}-${t.obstacleRotation.y}-${t.obstacleRotation.z}-${t.obstacleRadius}-${i.r}-${i.g}-${i.b}-${r}`;if(X!==this.lastObstacleParams){const{faceCount:G}=_?this.buildObstacleGeometry(t):{faceCount:0};this.lastFaceCount=G,G>0&&this.device.queue.writeBuffer(this.lineVertexBuffer,0,this.lineVertexData.buffer,this.lineVertexData.byteOffset,G*10*4),this.lastObstacleParams=X}const Y=this.lastFaceCount,N=`${t.showBoundsWireframe}-${t.boundsSize.x}-${t.boundsSize.y}-${t.boundsSize.z}-${t.boundsWireframeColor.r}-${t.boundsWireframeColor.g}-${t.boundsWireframeColor.b}`;if(N!==this.lastWireframeParams){let G=0;t.showBoundsWireframe&&(G=this.buildBoundsWireframe(t),this.device.queue.writeBuffer(this.wireframeVertexBuffer,0,this.wireframeVertexData.buffer,this.wireframeVertexData.byteOffset,G*7*4)),this.lastWireframeVertexCount=G,this.lastWireframeParams=N}const L=this.lastWireframeVertexCount;t.showBoundsWireframe&&L>0&&this.device.queue.writeBuffer(this.wireframeUniformBuffer,0,h.buffer,h.byteOffset,h.byteLength);const R=e.beginRenderPass({colorAttachments:[],depthStencilAttachment:{view:this.shadowTexture.createView(),depthClearValue:1,depthLoadOp:"clear",depthStoreOp:"store"}});R.setPipeline(this.shadowParticlePipeline),R.setBindGroup(0,this.shadowParticleBindGroup),t.showFluidShadows&&R.drawIndirect(a.indirectDraw,0),Y>0&&(R.setPipeline(this.shadowObstaclePipeline),R.setBindGroup(0,this.shadowObstacleBindGroup),R.setVertexBuffer(0,this.lineVertexBuffer,0),R.draw(Y)),R.end();const v=e.beginRenderPass({colorAttachments:[{view:n,clearValue:{r:.05,g:.05,b:.08,a:1},loadOp:"clear",storeOp:"store"}],depthStencilAttachment:{view:this.depthTexture.createView(),depthClearValue:1,depthLoadOp:"clear",depthStoreOp:"store"}});v.setPipeline(this.backgroundPipeline),v.setBindGroup(0,this.backgroundBindGroup),v.draw(3,1,0,0),v.setPipeline(this.particlePipeline),v.setBindGroup(0,this.particleBindGroup),v.drawIndirect(a.indirectDraw,0),Y>0&&(v.setPipeline(this.facePipeline),v.setBindGroup(0,this.faceBindGroup),v.setVertexBuffer(0,this.lineVertexBuffer,0),v.draw(Y)),t.showBoundsWireframe&&L>0&&(v.setPipeline(this.wireframePipeline),v.setBindGroup(0,this.wireframeBindGroup),v.setVertexBuffer(0,this.wireframeVertexBuffer,0),v.draw(L)),v.end()}}class De{device;clearPipeline;particlesPipeline;resolvePipeline;clearBindGroup;particlesBindGroup;resolveBindGroup;clearParamsBuffer;particlesParamsBuffer;resolveParamsBuffer;particlesParamsData;particlesParamsF32;particlesParamsU32;resolveParamsData;resolveParamsF32;resolveParamsU32;atomicDensityBuffer;densityTexture;_densityTextureView;densityTextureSize={x:1,y:1,z:1};densityWorkgroupSize={x:8,y:8,z:4};constructor(e){this.device=e;const n=e.createShaderModule({code:me});this.clearPipeline=e.createComputePipeline({layout:"auto",compute:{module:n,entryPoint:"main"}}),this.clearParamsBuffer=e.createBuffer({size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});const t=e.createShaderModule({code:Pe});this.particlesPipeline=e.createComputePipeline({layout:"auto",compute:{module:t,entryPoint:"main"}}),this.particlesParamsData=new ArrayBuffer(64),this.particlesParamsF32=new Float32Array(this.particlesParamsData),this.particlesParamsU32=new Uint32Array(this.particlesParamsData),this.particlesParamsBuffer=e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});const a=e.createShaderModule({code:ge});this.resolvePipeline=e.createComputePipeline({layout:"auto",compute:{module:a,entryPoint:"main"}}),this.resolveParamsData=new ArrayBuffer(32),this.resolveParamsF32=new Float32Array(this.resolveParamsData),this.resolveParamsU32=new Uint32Array(this.resolveParamsData),this.resolveParamsBuffer=e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}get textureView(){return this._densityTextureView}recreate(e,n){this.densityTexture&&this.densityTexture.destroy(),this.createDensityTexture(e),this.createAtomicDensityBuffer(),this.createBindGroups(n)}dispatch(e,n,t){this.updateParams(n,t);const a=this.densityTextureSize.x*this.densityTextureSize.y*this.densityTextureSize.z,s=e.beginComputePass();s.setPipeline(this.clearPipeline),s.setBindGroup(0,this.clearBindGroup),s.dispatchWorkgroups(Math.ceil(a/256)),s.end();const i=e.beginComputePass();i.setPipeline(this.particlesPipeline),i.setBindGroup(0,this.particlesBindGroup),i.dispatchWorkgroups(Math.ceil(n/256)),i.end();const r=e.beginComputePass();r.setPipeline(this.resolvePipeline),r.setBindGroup(0,this.resolveBindGroup),r.dispatchWorkgroups(Math.ceil(this.densityTextureSize.x/this.densityWorkgroupSize.x),Math.ceil(this.densityTextureSize.y/this.densityWorkgroupSize.y),Math.ceil(this.densityTextureSize.z/this.densityWorkgroupSize.z)),r.end()}destroy(){this.densityTexture&&this.densityTexture.destroy(),this.atomicDensityBuffer&&this.atomicDensityBuffer.destroy()}createDensityTexture(e){const n=e.boundsSize,t=Math.max(n.x,n.y,n.z),a=Math.max(1,Math.round(e.densityTextureRes)),s=Math.max(1,Math.round(n.x/t*a)),i=Math.max(1,Math.round(n.y/t*a)),r=Math.max(1,Math.round(n.z/t*a));this.densityTextureSize={x:s,y:i,z:r},this.densityTexture=this.device.createTexture({size:{width:s,height:i,depthOrArrayLayers:r},dimension:"3d",format:"rgba16float",usage:GPUTextureUsage.STORAGE_BINDING|GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_SRC}),this._densityTextureView=this.densityTexture.createView({dimension:"3d"})}createAtomicDensityBuffer(){this.atomicDensityBuffer&&this.atomicDensityBuffer.destroy();const e=this.densityTextureSize.x*this.densityTextureSize.y*this.densityTextureSize.z;this.atomicDensityBuffer=this.device.createBuffer({size:e*4,usage:GPUBufferUsage.STORAGE})}createBindGroups(e){this.clearBindGroup=this.device.createBindGroup({layout:this.clearPipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.atomicDensityBuffer}},{binding:1,resource:{buffer:this.clearParamsBuffer}}]}),this.particlesBindGroup=this.device.createBindGroup({layout:this.particlesPipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:e}},{binding:1,resource:{buffer:this.atomicDensityBuffer}},{binding:2,resource:{buffer:this.particlesParamsBuffer}}]}),this.resolveBindGroup=this.device.createBindGroup({layout:this.resolvePipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.atomicDensityBuffer}},{binding:1,resource:this._densityTextureView},{binding:2,resource:{buffer:this.resolveParamsBuffer}}]})}updateParams(e,n){const t=n.smoothingRadius,a=15/(2*Math.PI*Math.pow(t,5)),s=1e3,i=this.densityTextureSize.x*this.densityTextureSize.y*this.densityTextureSize.z,r=n.boundsSize,d=r.x*.5,o=r.z*.5,y=-5,h=n.densityTextureRes/Math.max(r.x,r.y,r.z),c=new Uint32Array(4);c[0]=i,this.device.queue.writeBuffer(this.clearParamsBuffer,0,c),this.particlesParamsF32[0]=t,this.particlesParamsF32[1]=a,this.particlesParamsU32[2]=e,this.particlesParamsF32[3]=s,this.particlesParamsF32[4]=-d,this.particlesParamsF32[5]=y,this.particlesParamsF32[6]=-o,this.particlesParamsF32[7]=h,this.particlesParamsF32[8]=d,this.particlesParamsF32[9]=y+r.y,this.particlesParamsF32[10]=o,this.particlesParamsF32[11]=0,this.particlesParamsU32[12]=this.densityTextureSize.x,this.particlesParamsU32[13]=this.densityTextureSize.y,this.particlesParamsU32[14]=this.densityTextureSize.z,this.particlesParamsU32[15]=0,this.device.queue.writeBuffer(this.particlesParamsBuffer,0,this.particlesParamsData),this.resolveParamsF32[0]=s,this.resolveParamsF32[1]=0,this.resolveParamsF32[2]=0,this.resolveParamsF32[3]=0,this.resolveParamsU32[4]=this.densityTextureSize.x,this.resolveParamsU32[5]=this.densityTextureSize.y,this.resolveParamsU32[6]=this.densityTextureSize.z,this.resolveParamsU32[7]=0,this.device.queue.writeBuffer(this.resolveParamsBuffer,0,this.resolveParamsData)}}class Te{device;context;config;buffers;physics;grid;renderer;splatPipeline;pickingSystem;state;gridRes={x:0,y:0,z:0};gridTotalCells=0;isPicking=!1;interactionPos={x:0,y:0,z:0};physicsUniforms;gridUniforms;cullUniformBuffer;computeData=new Float32Array(8);integrateData=new Float32Array(24);hashParamsData=new Float32Array(8);sortParamsData=new Uint32Array(8);scanParamsDataL0=new Uint32Array(4);scanParamsDataL1=new Uint32Array(4);scanParamsDataL2=new Uint32Array(4);densityParamsData=new Float32Array(12);pressureParamsData=new Float32Array(16);viscosityParamsData=new Float32Array(12);cullParamsData=new Float32Array(20);indirectArgs=new Uint32Array([6,0,0,0]);constructor(e,n,t,a,s){this.device=e,this.context=n,this.config=a,this.physics=new ce(e),this.grid=new ue(e),this.renderer=new Be(e,t,s,a),this.splatPipeline=new De(e),this.pickingSystem=new de(e),this.physicsUniforms={external:e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),density:e.createBuffer({size:48,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),pressure:e.createBuffer({size:64,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),viscosity:e.createBuffer({size:48,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),integrate:e.createBuffer({size:96,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})},this.gridUniforms={hash:e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),sort:e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),scanL0:e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),scanL1:e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),scanL2:e.createBuffer({size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})},this.cullUniformBuffer=e.createBuffer({size:80,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.reset()}get particleCount(){return this.buffers.particleCount}get simulationState(){return this.state}reset(){this.buffers&&this.buffers.destroy();const{boundsSize:e,smoothingRadius:n}=this.config;this.gridRes={x:Math.ceil(e.x/n),y:Math.ceil(e.y/n),z:Math.ceil(e.z/n)},this.gridTotalCells=this.gridRes.x*this.gridRes.y*this.gridRes.z;const t=he(this.config);this.state=this.createStateFromSpawn(t),this.buffers=new fe(this.device,t,{gridTotalCells:this.gridTotalCells}),this.physics.createBindGroups(this.buffers,this.physicsUniforms),this.grid.createBindGroups(this.buffers,this.gridUniforms),this.splatPipeline.recreate(this.config,this.buffers.predicted),this.pickingSystem.createBindGroup(this.buffers.positions),this.renderer.createBindGroup(this.buffers,this.splatPipeline.textureView,this.cullUniformBuffer);const a=this.device.createCommandEncoder();this.splatPipeline.dispatch(a,this.buffers.particleCount,this.config),this.device.queue.submit([a.finish()])}createStateFromSpawn(e){return{positions:e.positions,predicted:new Float32Array(e.positions),velocities:e.velocities,densities:new Float32Array(e.count*2),keys:new Uint32Array(e.count),sortedKeys:new Uint32Array(e.count),indices:new Uint32Array(e.count),sortOffsets:new Uint32Array(e.count),spatialOffsets:new Uint32Array(e.count),positionsSorted:new Float32Array(e.count*4),predictedSorted:new Float32Array(e.count*4),velocitiesSorted:new Float32Array(e.count*4),count:e.count,input:{worldX:0,worldY:0,worldZ:0,pull:!1,push:!1}}}async step(e){const{config:n,buffers:t,device:a}=this,s=n.maxTimestepFPS?1/n.maxTimestepFPS:Number.POSITIVE_INFINITY,r=Math.min(e*n.timeScale,s)/n.iterationsPerFrame;this.updateUniforms(r);const d=a.createCommandEncoder();let o=!1;!this.isPicking&&this.state.input.rayOrigin&&this.state.input.rayDir&&(this.isPicking=!0,o=!0,this.pickingSystem.dispatch(d,this.state.input.rayOrigin,this.state.input.rayDir,n.smoothingRadius,t.particleCount));const y=d.beginComputePass();for(let c=0;c<n.iterationsPerFrame;c++)this.physics.step(y,this.grid,t.particleCount,this.gridTotalCells,n.viscosityStrength>0,c===0);y.end(),n.showFluidShadows&&this.splatPipeline.dispatch(d,t.particleCount,n),a.queue.submit([d.finish()]),o&&this.pickingSystem.getResult().then(c=>{if(c&&c.hit){let u=c.hitPos.x,b=c.hitPos.y,P=c.hitPos.z;this.state.input.pull&&this.state.input.rayDir&&(u+=this.state.input.rayDir.x*.5,b+=this.state.input.rayDir.y*.5,P+=this.state.input.rayDir.z*.5),this.state.input.worldX=u,this.state.input.worldY=b,this.state.input.worldZ=P,this.state.input.isHoveringFluid=!0}else this.state.input.isHoveringFluid=!1;this.isPicking=!1});const h=.15;this.interactionPos.x+=(this.state.input.worldX-this.interactionPos.x)*h,this.interactionPos.y+=(this.state.input.worldY-this.interactionPos.y)*h,this.interactionPos.z+=(this.state.input.worldZ-this.interactionPos.z)*h}updateUniforms(e){const{config:n,state:t,buffers:a,device:s}=this;let i=0;t.input.push?i=-n.interactionStrength:t.input.pull&&(i=n.interactionStrength),this.computeData[0]=e,this.computeData[1]=n.gravity,this.computeData[2]=n.interactionRadius,this.computeData[3]=i,this.computeData[4]=this.interactionPos.x,this.computeData[5]=this.interactionPos.y,this.computeData[6]=this.interactionPos.z,this.computeData[7]=0,s.queue.writeBuffer(this.physicsUniforms.external,0,this.computeData),this.hashParamsData[0]=n.smoothingRadius,this.hashParamsData[1]=a.particleCount,this.hashParamsData[2]=-n.boundsSize.x*.5,this.hashParamsData[3]=-5,this.hashParamsData[4]=-n.boundsSize.z*.5,this.hashParamsData[5]=this.gridRes.x,this.hashParamsData[6]=this.gridRes.y,this.hashParamsData[7]=this.gridRes.z,s.queue.writeBuffer(this.gridUniforms.hash,0,this.hashParamsData),this.sortParamsData[0]=a.particleCount,this.sortParamsData[1]=this.gridTotalCells,s.queue.writeBuffer(this.gridUniforms.sort,0,this.sortParamsData);const r=Math.ceil((this.gridTotalCells+1)/512),d=Math.ceil(r/512);this.scanParamsDataL0[0]=this.gridTotalCells+1,this.scanParamsDataL1[0]=r,this.scanParamsDataL2[0]=d,s.queue.writeBuffer(this.gridUniforms.scanL0,0,this.scanParamsDataL0),s.queue.writeBuffer(this.gridUniforms.scanL1,0,this.scanParamsDataL1),s.queue.writeBuffer(this.gridUniforms.scanL2,0,this.scanParamsDataL2);const o=n.smoothingRadius,y=15/(2*Math.PI*Math.pow(o,5)),h=15/(Math.PI*Math.pow(o,6));this.densityParamsData[0]=o,this.densityParamsData[1]=y,this.densityParamsData[2]=h,this.densityParamsData[3]=a.particleCount,this.densityParamsData[4]=-n.boundsSize.x*.5,this.densityParamsData[5]=-5,this.densityParamsData[6]=-n.boundsSize.z*.5,this.densityParamsData[7]=0,this.densityParamsData[8]=this.gridRes.x,this.densityParamsData[9]=this.gridRes.y,this.densityParamsData[10]=this.gridRes.z,this.densityParamsData[11]=0,s.queue.writeBuffer(this.physicsUniforms.density,0,this.densityParamsData);const c=15/(Math.PI*Math.pow(o,5)),u=45/(Math.PI*Math.pow(o,6));this.pressureParamsData[0]=e,this.pressureParamsData[1]=n.targetDensity,this.pressureParamsData[2]=n.pressureMultiplier,this.pressureParamsData[3]=n.nearPressureMultiplier,this.pressureParamsData[4]=o,this.pressureParamsData[5]=c,this.pressureParamsData[6]=u,this.pressureParamsData[7]=a.particleCount,this.pressureParamsData[8]=-n.boundsSize.x*.5,this.pressureParamsData[9]=-5,this.pressureParamsData[10]=-n.boundsSize.z*.5,this.pressureParamsData[11]=0,this.pressureParamsData[12]=this.gridRes.x,this.pressureParamsData[13]=this.gridRes.y,this.pressureParamsData[14]=this.gridRes.z,this.pressureParamsData[15]=0,s.queue.writeBuffer(this.physicsUniforms.pressure,0,this.pressureParamsData);const b=315/(64*Math.PI*Math.pow(o,9));this.viscosityParamsData[0]=e,this.viscosityParamsData[1]=n.viscosityStrength,this.viscosityParamsData[2]=o,this.viscosityParamsData[3]=b,this.viscosityParamsData[4]=a.particleCount,this.viscosityParamsData[5]=-n.boundsSize.x*.5,this.viscosityParamsData[6]=-5,this.viscosityParamsData[7]=-n.boundsSize.z*.5,this.viscosityParamsData[8]=this.gridRes.x,this.viscosityParamsData[9]=this.gridRes.y,this.viscosityParamsData[10]=this.gridRes.z,this.viscosityParamsData[11]=0,s.queue.writeBuffer(this.physicsUniforms.viscosity,0,this.viscosityParamsData),this.integrateData[0]=e,this.integrateData[1]=n.collisionDamping;const m=(n.obstacleShape??"box")==="sphere",x=n.obstacleRadius??0,z=n.showObstacle!==!1&&(m?x>0:n.obstacleSize.x>0&&n.obstacleSize.y>0&&n.obstacleSize.z>0);this.integrateData[2]=z?1:0,this.integrateData[3]=m?1:0;const f=n.boundsSize,I=f.x*.5,B=f.z*.5,k=-5;this.integrateData[4]=-I,this.integrateData[5]=k,this.integrateData[6]=-B,this.integrateData[8]=I,this.integrateData[9]=k+f.y,this.integrateData[10]=B,this.integrateData[12]=n.obstacleCentre.x,this.integrateData[13]=m?n.obstacleCentre.y:n.obstacleCentre.y+n.obstacleSize.y*.5,this.integrateData[14]=n.obstacleCentre.z;const O=m?x:n.obstacleSize.x*.5,j=m?x:n.obstacleSize.y*.5,l=m?x:n.obstacleSize.z*.5;this.integrateData[16]=O,this.integrateData[17]=j,this.integrateData[18]=l,this.integrateData[20]=n.obstacleRotation.x,this.integrateData[21]=n.obstacleRotation.y,this.integrateData[22]=n.obstacleRotation.z,s.queue.writeBuffer(this.physicsUniforms.integrate,0,this.integrateData)}render(e){const{device:n,buffers:t,config:a}=this;this.renderer.resize();const s=n.createCommandEncoder();this.device.queue.writeBuffer(t.indirectDraw,0,this.indirectArgs);const i=this.context.canvas.width/this.context.canvas.height,r=se(Math.PI/3,i,.1,100),d=ee(r,e);this.cullParamsData.set(d),this.cullParamsData[16]=a.particleRadius,new Uint32Array(this.cullParamsData.buffer)[17]=t.particleCount,this.device.queue.writeBuffer(this.cullUniformBuffer,0,this.cullParamsData),this.renderer.render(s,this.context.getCurrentTexture().createView(),this.config,this.buffers,e),this.device.queue.submit([s.finish()])}}export{Te as F};
