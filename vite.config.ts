    ...
    rollupOptions: {
      input: {
        ...
        'demo-3d-particles': resolve(
          __dirname,
          'src/3d/webgpu_particles/index.html'
        ),
        'demo-3d-raymarch': resolve(
          __dirname,
          'src/3d/webgpu_raymarch/index.html'
        ),
        'demo-3d-screen-space': resolve(
          __dirname,
          'src/3d/webgpu_screen_space/index.html'
        ),
        'demo-3d-marching-cubes': resolve(
          __dirname,
          'src/3d/webgpu_marching_cubes/index.html'
        ),
        'demo-3d-fluid-combined': resolve(
          __dirname,
          'src/3d/webgpu_fluid/index.html'
        ),
